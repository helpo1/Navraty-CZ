...
instance MENUITEM_VID_WINDOW(C_MENU_ITEM_DEF)
{
	...
	text[1] = "Zapnout animace oken rozhovorů ve hře";
	posx = 0;
...
{
	backPic = MENU_ITEM_BACK_PIC;
	text[0] = "Grafická karta";
	text[1] = "Grafická karta používaná ve hře";
	posx = 0;
...
instance MENUITEM_VID_RESOLUTION(C_MENU_ITEM_DEF)
{
	backPic = MENU_ITEM_BACK_PIC;
	text[0] = "Rozlišení";
	text[1] = "Nastavení rozlišení a barevné hloubky";
	posx = 0;
	posy = MENU_START_Y + (MENU_DY * 1);
	dimx = 7000;
	dimy = 750;
...
{
	backPic = MENU_ITEM_BACK_PIC;
	text[0] = "Škálování videa";
	text[1] = "Zapnout automatickou změnu velikosti videoklipů ve hře";
	posx = 0;
...
instance MENUITEM_VID_BRIGHTNESS(C_MENU_ITEM_DEF)
{
	backPic = MENU_ITEM_BACK_PIC;
	text[0] = "Jas";
	text[1] = "Nastavení světlosti obrazu ve hře";
	posx = 0;
...
instance MENUITEM_VID_CONTRAST(C_MENU_ITEM_DEF)
{
	backPic = MENU_ITEM_BACK_PIC;
	text[0] = "Kontrast";
	text[1] = "Nastavení kontrastnosti obrazu ve hře";
	posx = 0;
...
instance MENUITEM_VID_GAMMA(C_MENU_ITEM_DEF)
{
	backPic = MENU_ITEM_BACK_PIC;
	text[0] = "Gamma";
	text[1] = "Nastavení gamma korekce obrazu ve hře";
	posx = 0;
