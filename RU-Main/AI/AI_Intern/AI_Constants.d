...
const int Face_N_Normal_Olli_Kahn = 67; //Абигаль
...
const int Face_L_NormalBart_Rufus = 128; //Кассия
...
const int Face_XG_Player = 199; //тату разбитое лицо
const int Face_X_Player = 200;	//разбитое лицо
const int Face_NG_Player = 201;	//тату
const int Face_NX_Player = 202;	//лысый ГГ без тату
const int Face_XNG_Player = 203; //лысый ГГ с тату
...
const int SPL_COST_BELIARSRUNE_SUPER = 60;
...
const int SPL_DAMAGE_SUPERBELIARSRUNE = 600;
