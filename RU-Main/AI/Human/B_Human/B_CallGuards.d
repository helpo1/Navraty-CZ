...
func void B_CallGuards()
{
	...
	if((Hlp_GetInstanceID(self) == Hlp_GetInstanceID(NONE_119_Assasin)) || (Hlp_GetInstanceID(self) == Hlp_GetInstanceID(NONE_1190_Assasin)) || (Hlp_GetInstanceID(self) == Hlp_GetInstanceID(NONE_1191_Assasin)))
	{
		return;
	};
	...
	{
		if((self.guild == GIL_MIL) || (self.guild == GIL_PAL) || (self.guild == GIL_SLD) || (self.guild == GIL_TPL))
		{
			B_Say_Overlay(self,other,"$ALARM");
		...
		{
			if((self.guild != GIL_BDT) && (self.guild != GIL_PIR))
			{
