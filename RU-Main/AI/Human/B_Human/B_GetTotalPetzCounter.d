...
func int B_GetTotalPetzCounter(var C_Npc slf)
{
	...
	{
		return PETZCOUNTER_COAST_MURDER + PETZCOUNTER_COAST_THEFT + PETZCOUNTER_COAST_ATTACK;
	};
	if(c_npcbelongstopsicamp(slf))
	{
		return PETZCOUNTER_PSICAMP_MURDER + PETZCOUNTER_PSICAMP_THEFT + PETZCOUNTER_PSICAMP_ATTACK;
	};
	return 0;
};
