...
func void countcombination()
{
	if(PLAYERTURN == TRUE)
	{
		...
		if(PLAYERCOMB == 0)
		{
			if((ONECOUNT == 2) || (TWOCOUNT == 2) || (THREECOUNT == 2) || (FOURCOUNT == 2) || (FIVECOUNT == 2) || (SIXCOUNT == 2))
			{
				if(ONECOUNT == 2)
				{
					...
					{
						PLAYERCOMBINATION = ConcatStrings(PLAYERCOMBINATION,"пара на '1'");
						PLAYERCOMB = 1;
					};
				}
				else if(TWOCOUNT == 2)
				{
					...
					{
						PLAYERCOMBINATION = ConcatStrings(PLAYERCOMBINATION,"пара на '2'");
						PLAYERCOMB = 2;
					};
				}
				else if(THREECOUNT == 2)
				{
					...
					{
						PLAYERCOMBINATION = ConcatStrings(PLAYERCOMBINATION,"пара на '3'");
						PLAYERCOMB = 3;
					};
				}
				else if(FOURCOUNT == 2)
				{
					...
					{
						PLAYERCOMBINATION = ConcatStrings(PLAYERCOMBINATION,"пара на '4'");
						PLAYERCOMB = 4;
					};
				}
				else if(FIVECOUNT == 2)
				{
					...
					{
						PLAYERCOMBINATION = ConcatStrings(PLAYERCOMBINATION,"пара на '5'");
						PLAYERCOMB = 5;
					};
				}
				else if(SIXCOUNT == 2)
				{
					PLAYERCOMBINATION = ConcatStrings(PLAYERCOMBINATION,"пара на '6'");
					PLAYERCOMB = 6;
				};
			};
		};
		...
		if(PLAYERCOMB == 0)
		{
			...
			{
				PLAYERCOMBINATION = ConcatStrings(PLAYERCOMBINATION,"каре на ");
				if(ONECOUNT == 4)
				{
		...
		if(PLAYERCOMB == 0)
		{
			...
			{
				PLAYERCOMBINATION = ConcatStrings(PLAYERCOMBINATION,"покер на ");
				if(ONECOUNT == 5)
				{
					PLAYERCOMBINATION = ConcatStrings(PLAYERCOMBINATION,"'1'");
					PLAYERCOMB = 39;
		...
		if(PLAYERCOMB == 0)
		{
			PLAYERCOMBINATION = ConcatStrings(PLAYERCOMBINATION,"ничего");
		};
	...
	else
	{
		...
		if(NPCCOMB == 0)
		{
			if((NPCONECOUNT == 2) || (NPCTWOCOUNT == 2) || (NPCTHREECOUNT == 2) || (NPCFOURCOUNT == 2) || (NPCFIVECOUNT == 2) || (NPCSIXCOUNT == 2))
			{
				if(NPCONECOUNT == 2)
				{
					...
					{
						NPCCOMBINATION = ConcatStrings(NPCCOMBINATION,"пара на '1'");
						NPCCOMB = 1;
					};
				}
				else if(NPCTWOCOUNT == 2)
				{
					...
					{
						NPCCOMBINATION = ConcatStrings(NPCCOMBINATION,"пара на '2'");
						NPCCOMB = 2;
					};
				}
				else if(NPCTHREECOUNT == 2)
				{
					...
					{
						NPCCOMBINATION = ConcatStrings(NPCCOMBINATION,"пара на '3'");
						NPCCOMB = 3;
					};
				}
				else if(NPCFOURCOUNT == 2)
				{
					...
					{
						NPCCOMBINATION = ConcatStrings(NPCCOMBINATION,"пара на '4'");
						NPCCOMB = 4;
					};
				}
				else if(NPCFIVECOUNT == 2)
				{
					...
					{
						NPCCOMBINATION = ConcatStrings(NPCCOMBINATION,"пара на '5'");
						NPCCOMB = 5;
					};
				}
				else if(NPCSIXCOUNT == 2)
				{
					NPCCOMBINATION = ConcatStrings(NPCCOMBINATION,"пара на '6'");
					NPCCOMB = 6;
				};
			};
		};
		...
		if(NPCCOMB == 0)
		{
			...
			{
				NPCCOMBINATION = ConcatStrings(NPCCOMBINATION,"каре на ");
				if(NPCONECOUNT == 4)
				{
		...
		if(NPCCOMB == 0)
		{
			...
			{
				NPCCOMBINATION = ConcatStrings(NPCCOMBINATION,"покер на ");
				if(NPCONECOUNT == 5)
				{
					NPCCOMBINATION = ConcatStrings(NPCCOMBINATION,"'1'");
					NPCCOMB = 39;
		...
		if(NPCCOMB == 0)
		{
			NPCCOMBINATION = ConcatStrings(NPCCOMBINATION,"ничего");
		};
...
func void pc_playpocker_continue_info()
{
	...
	{
		PrintScreen("Ничья...",45,YPOS_LOGENTRY,FONT_NEWLEVEL,9999);
	};
};
