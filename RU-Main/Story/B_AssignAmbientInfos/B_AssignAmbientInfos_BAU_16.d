...
func void DIA_BAU_16_STANDARD_Info()
{
	...
	if(Kapitel == 5)
	{
		AI_Output(self,other,"DIA_BAU_16_STANDARZ_16_05");	//Нежить заполонила весь Хоринис! Теперь и шагу ступить опасно за пределы фермы.
	};
	if(Kapitel >= 6)
	{
		AI_Output(self,other,"DIA_BAU_16_STANDARD_16_06");	//У паладинов не было ни одного шанса. Орки смяли их оборону за считанные минуты. Что будет с нами?!
	};
};
