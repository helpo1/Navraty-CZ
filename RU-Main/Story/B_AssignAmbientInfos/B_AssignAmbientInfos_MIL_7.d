...
func void DIA_MIL_7_PEOPLE_Info()
{
	...
	AI_Output(self,other,"DIA_MIL_7_PEOPLE_07_02");	//Они взяли всю власть в городе в свои руки. Выгнали главу города из зала заседаний и судью из его палаты.
...
func void DIA_MIL_7_STANDARD_Info()
{
	...
	if(Kapitel == 5)
	{
		AI_Output(self,other,"DIA_MIL_7_STANDARZ_07_06");	//Каждый день на город нападает нежить. Чем же мы все так провинились перед Инносом?!
	};
	if(Kapitel >= 6)
	{
		AI_Output(self,other,"DIA_MIL_7_STANDARD_07_07");	//У нас нет ни единого шанса против элитных орков! О Иннос, что с нами будет?!
	};
};
