...
instance BAU_936_Rosi(Npc_Default)
{
	...
	B_SetNpcVisual(self,FEMALE,"Hum_Head_Babe0",FaceBabe_N_Hure,BodyTexBabe_N,ITAR_BauBabe_M);
...
func void rtn_followpsicamp_936()
{
	TA_Follow_Player(8,0,22,0,"NW_TAVERNE_TROLLAREA_14");
	TA_Follow_Player(22,0,8,0,"NW_TAVERNE_TROLLAREA_14");
};
...
func void rtn_psicamp_936()
{
	TA_Smalltalk(8,0,22,0,"NW_PSICAMP_SHEEP_01");
	TA_Smalltalk(22,0,8,0,"NW_PSICAMP_SHEEP_01");
};
