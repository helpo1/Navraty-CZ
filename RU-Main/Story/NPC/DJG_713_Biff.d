...
{
	TA_Practice_Sword(8,0,23,0,"OW_MOVEMENT_BGOBBO3");
	TA_Stand_ArmsCrossed(23,0,8,0,"OW_MOVEMENT_BGOBBO3");
};
...
func void rtn_sturm_713()
{
	TA_Stand_Guarding(8,0,23,0,"OC_DJG_JOIN_07_07");
	TA_Stand_Guarding(23,0,8,0,"OC_DJG_JOIN_07_07");
};

func void rtn_followsturm_713()
{
	TA_Follow_Player(8,0,22,0,"OC_EBR_HALL_THRONE");
	TA_Follow_Player(22,0,8,0,"OC_EBR_HALL_THRONE");
};

func void rtn_castle_713()
{
	TA_Stand_Guarding(8,0,23,0,"OC_GATE_GUARD_02");
	TA_Stand_Guarding(23,0,8,0,"OC_GATE_GUARD_02");
};

func void rtn_palexit_713()
{
