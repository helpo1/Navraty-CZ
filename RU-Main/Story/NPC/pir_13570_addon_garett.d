...
instance PIR_13570_ADDON_GARETT(Npc_Default)
{
	name[0] = "Гаррет";
	guild = GIL_PAL;
	id = 13570;
...
{
	TA_Stand_Guarding(9,0,23,0,"NW_BIGFARM_CAMPON_PIR_12");
	TA_Stand_Guarding(23,0,9,0,"NW_BIGFARM_CAMPON_PIR_12");
};

func void rtn_inbattle_13570()
{
	ta_bigfight(8,0,22,0,"NW_BIGFIGHT_PIR_02");
	ta_bigfight(22,0,8,0,"NW_BIGFIGHT_PIR_02");
};

func void rtn_ship_13570()
{
