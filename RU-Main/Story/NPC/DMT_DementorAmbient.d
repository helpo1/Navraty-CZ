...
prototype Default_AmbientDementor_Master(C_Npc)
{
...
instance DMT_DementorAmbient_Master(Default_AmbientDementor_Master)
{
	start_aistate = ZS_Stand_Dementor;
};
...
instance DMT_DementorFriendly(Default_AmbientDementor)
{
...
{
	name[0] = "Миалекс, зодчий храма Ирдората";
	id = 1236;
	aivar[AIV_EnemyOverride] = TRUE;
	B_SetAttributesToChapter(self,7);
...
instance DMT_DementorAmbientWalker_DI_01(Default_AmbientDementor_Master)
{
	id = 1237;
...
instance DMT_DementorAmbientWalker_DI_02(Default_AmbientDementor_Master)
{
	id = 1238;
...
instance DMT_DementorAmbientWalker_DI_03(Default_AmbientDementor_Master)
{
	id = 1239;
...
instance DMT_DementorAmbientWalker_DI_04(Default_AmbientDementor_Master)
{
	id = 1240;
...
instance DMT_DementorAmbientWalker_DI_05(Default_AmbientDementor_Master)
{
	id = 1242;
...
instance DMT_DementorAmbientWalker_DI_06(Default_AmbientDementor_Master)
{
	id = 1243;
...
instance DEMENTOR_REST_01(Default_AmbientDementor)
{
	id = 1244;
...
{
	TA_Stand_Dementor(6,0,22,0,"PSI_DEMENTOR_01");
	TA_Stand_Dementor(22,0,6,0,"PSI_DEMENTOR_01");
};


instance DEMENTOR_READ_01(Default_AmbientDementor)
{
	id = 1245;
...
{
	TA_Read_Bookstand(6,0,22,0,"PSI_DEMENTOR_02");
	TA_Read_Bookstand(22,0,6,0,"PSI_DEMENTOR_02");
};


instance DEMENTOR_READ_02(Default_AmbientDementor)
{
	id = 1246;
...
{
	TA_Read_Bookstand(6,0,22,0,"PSI_DEMENTOR_03");
	TA_Read_Bookstand(22,0,6,0,"PSI_DEMENTOR_03");
};


instance DEMENTOR_READ_03(Default_AmbientDementor)
{
	id = 1247;
...
{
	TA_Read_Bookstand(6,0,22,0,"PSI_DEMENTOR_04");
	TA_Read_Bookstand(22,0,6,0,"PSI_DEMENTOR_04");
};


instance DEMENTOR_READ_04(Default_AmbientDementor)
{
	id = 1248;
...
{
	TA_Read_Bookstand(6,0,22,0,"PSI_DEMENTOR_05");
	TA_Read_Bookstand(22,0,6,0,"PSI_DEMENTOR_05");
};


instance DEMENTOR_READ_05(Default_AmbientDementor)
{
	id = 1249;
...
{
	TA_Read_Bookstand(6,0,22,0,"PSI_DEMENTOR_06");
	TA_Read_Bookstand(22,0,6,0,"PSI_DEMENTOR_06");
};


instance DEMENTOR_READ_06(Default_AmbientDementor)
{
	id = 1250;
	daily_routine = rtn_start_1250;
};


func void rtn_start_1250()
{
	TA_Read_Bookstand(6,0,22,0,"PSI_DEMENTOR_12");
	TA_Read_Bookstand(22,0,6,0,"PSI_DEMENTOR_12");
};


instance DEMENTOR_READ_07(Default_AmbientDementor)
{
	id = 1251;
...
{
	TA_Read_Bookstand(6,0,22,0,"PSI_DEMENTOR_13");
	TA_Read_Bookstand(22,0,6,0,"PSI_DEMENTOR_13");
};


instance DEMENTOR_PRMA_01(Default_AmbientDementor)
{
	id = 1252;
...
{
	TA_Circle(6,0,22,0,"PSI_DEMENTOR_07");
	TA_Circle(22,0,6,0,"PSI_DEMENTOR_07");
};


instance DEMENTOR_PRMA_02(Default_AmbientDementor)
{
	id = 1253;
...
{
	TA_Circle(6,0,22,0,"PSI_DEMENTOR_10");
	TA_Circle(22,0,6,0,"PSI_DEMENTOR_10");
};


instance DEMENTOR_PRMA_03(Default_AmbientDementor)
{
	id = 1254;
	daily_routine = rtn_start_1254;
};


func void rtn_start_1254()
{
	TA_Circle(6,0,22,0,"PSI_DEMENTOR_11");
	TA_Circle(22,0,6,0,"PSI_DEMENTOR_11");
};


instance DEMENTOR_MAPO_01(Default_AmbientDementor)
{
	id = 1255;
	daily_routine = rtn_start_1255;
};


func void rtn_start_1255()
{
	TA_Potion_Alchemy(6,0,22,0,"PSI_DEMENTOR_08");
	TA_Potion_Alchemy(22,0,6,0,"PSI_DEMENTOR_08");
};


instance DEMENTOR_MAPO_02(Default_AmbientDementor)
{
	id = 1256;
...
{
	TA_Potion_Alchemy(6,0,22,0,"PSI_DEMENTOR_09");
	TA_Potion_Alchemy(22,0,6,0,"PSI_DEMENTOR_09");
};

//------------Альтернатива----------------------------------------------

instance DMT_2200_DarkSpeaker(Npc_Default)
{
	name[0] = "Темный вестник";
	guild = GIL_DMT;
	id = 2200;
	level = 30;
	voice = 9;
...
{
	TA_Stand_Dementor(8,0,23,0,"NW_PASS_GATE_02");
	TA_Stand_Dementor(23,0,8,0,"NW_PASS_GATE_02");
};

func void rtn_TOT_2200()
{
	TA_Stand_Dementor(8,0,23,0,"TOT");
	TA_Stand_Dementor(23,0,8,0,"TOT");
};

func void rtn_Circle_2200()
{
	TA_Stand_Dementor(8,0,23,0,"NW_TROLLAREA_RITUALPATH_01");
	TA_Stand_Dementor(23,0,8,0,"NW_TROLLAREA_RITUALPATH_01");
};

func void rtn_Ritual_2200()
{
	TA_Circle(8,0,23,0,"NW_TROLLAREA_RITUAL_01");
	TA_Circle(23,0,8,0,"NW_TROLLAREA_RITUAL_01");
};

instance DMT_2201_Krah(Npc_Default)
{
	name[0] = "Эк'Рах, темный настоятель";
	guild = GIL_DMT;
	id = 2201;
	voice = 19;
	flags = NPC_FLAG_IMMORTAL;
...
{
	TA_Stand_Dementor(8,0,23,0,"NW_DARKMASTER_02");
	TA_Stand_Dementor(23,0,8,0,"NW_DARKMASTER_02");
};

//---------------------------НПС храма Белиара---------------------------

instance DMT_2202_Kirat(Npc_Default)
{
	name[0] = "Кират";
	guild = GIL_DMT;
	id = 2202;
...
{
	TA_Stand_Guarding(8,0,23,0,"DT_KIRATWAIT_01");
	TA_Stand_Guarding(23,0,8,0,"DT_KIRATWAIT_01");
};

func void Rtn_WaitInHram_2202()
{
	TA_Stand_Guarding(8,0,23,0,"DT_KIRATWAIT_02");
	TA_Stand_Guarding(23,0,8,0,"DT_KIRATWAIT_02");
};

instance DMT_2203_Miragul(Npc_Default)
{
	name[0] = "Ми'Аргул, темный настоятель";
	guild = GIL_DMT;
	id = 2203;
	voice = 19;
	flags = NPC_FLAG_IMMORTAL;
...
{
	TA_Stand_Dementor(8,0,23,0,"DT_MIRAGUL_01");
	TA_Stand_Dementor(23,0,8,0,"DT_MIRAGUL_01");
};

instance DMT_2204_Mulzog(Npc_Default)
{
	name[0] = "Мулзог, темный настоятель";
	guild = GIL_DMT;
	id = 2204;
	voice = 19;
	flags = NPC_FLAG_IMMORTAL;
...
{
	TA_Stand_Dementor(8,0,23,0,"DT_MULZOG_01");
	TA_Stand_Dementor(23,0,8,0,"DT_MULZOG_01");
};

instance DMT_2205_Norrat(Npc_Default)
{
	name[0] = "Норрат, темный настоятель";
	guild = GIL_DMT;
	id = 2205;
	voice = 19;
	flags = NPC_FLAG_IMMORTAL;
...
{
	TA_Stand_Dementor(8,0,23,0,"DT_NORRAT_01");
	TA_Stand_Dementor(23,0,8,0,"DT_NORRAT_01");
};
