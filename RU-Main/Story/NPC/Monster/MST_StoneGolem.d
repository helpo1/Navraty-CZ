...
{
	name[0] = "Каметор, каменный атронах";
	guild = GIL_STONEGOLEM;
	flags = 0;
	bodyStateInterruptableOverride = TRUE;
	level = 1000;
...
{
	name[0] = "Фарагон, огненный атронах";
	guild = GIL_FIREGOLEM;
	level = 1000;
	flags = 0;
	bodyStateInterruptableOverride = TRUE;
