...
instance BAU_940_Akil(Npc_Default)
{
	...
	B_SetNpcVisual(self,MALE,"Hum_Head_FatBald",Face_N_NormalBart_Grim,BodyTex_N,ITAR_Bau_M_Ext);
...
{
	TA_Sit_Bench(5,0,10,0,"NW_FARM2_OUT_05");
	TA_Stand_Guarding(10,0,12,0,"NW_FARM2_PATH_01_B");
	TA_Sit_Bench(12,0,14,0,"NW_FARM2_OUT_05");
	TA_Stand_Guarding(14,0,16,0,"NW_FARM2_FIELD_01");
	TA_Wood_Choop(16,0,21,0,"NW_FARM2_BENCH_02");
	TA_Sit_Bench(21,0,0,0,"NW_FARM2_OUT_06");
	TA_Sleep(0,0,5,0,"NW_FARM2_HOUSE_IN_02");
};

func void rtn_hideincave_940()
{
	TA_Cook_Campfire(8,0,22,0,"NW_FOREST_CAVE1_IN_05");
	TA_Cook_Campfire(22,0,8,0,"NW_FOREST_CAVE1_IN_05");
};
