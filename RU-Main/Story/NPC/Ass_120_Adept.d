...
{
	name[0] = "Тиамант Кровавый, приор Масиафа";
	guild = GIL_BDT;
	id = 125;
	voice = 9;
	flags = 0;
...
{
	name[0] = "Ханиар Слепец, приор Масиафа";
	guild = GIL_BDT;
	id = 126;
	voice = 9;
	flags = 0;
...
{
	name[0] = "Осаир Бессердечный, приор Масиафа";
	guild = GIL_BDT;
	id = 127;
	voice = 9;
	flags = 0;
...
{
	name[0] = "Нрозас Гадюка, приор Масиафа";
	guild = GIL_BDT;
	id = 128;
	voice = 9;
	flags = 0;
...
{
	name[0] = "Проклятый приор Масиафа";
	guild = GIL_DMT;
	id = 129;
	voice = 19;
	npcType = npctype_main;
