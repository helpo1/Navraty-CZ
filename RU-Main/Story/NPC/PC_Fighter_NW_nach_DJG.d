...
func void rtn_shipnew_706()
{
	TA_Stand_Guarding(8,0,22,0,"SHIP_DECK_15");
	TA_Stand_Guarding(22,0,8,0,"SHIP_DECK_15");
};

func void rtn_capturethrbattle_706()
{
	TA_Stand_ArmsCrossed(8,0,23,0,"NW_CITY_HABOUR_KASERN_RENGARU");
	TA_Stand_ArmsCrossed(23,0,8,0,"NW_CITY_HABOUR_KASERN_RENGARU");
};

func void rtn_inbattle_706()
{
	ta_bigfight(8,0,22,0,"NW_BIGFIGHT_HUM_00");
	ta_bigfight(22,0,8,0,"NW_BIGFIGHT_HUM_00");
};

func void rtn_fleefrombattle_706()
{
	TA_FleeToWp(8,0,22,0,"NW_TROLLAREA_RITUAL_04");
	TA_FleeToWp(22,0,8,0,"NW_TROLLAREA_RITUAL_04");
};

func void rtn_lost_706()
{
	TA_Stand_Guarding(9,0,23,0,"NW_TROLLAREA_RITUAL_04");
	TA_Stand_Guarding(23,0,9,0,"NW_TROLLAREA_RITUAL_04");
};

func void rtn_follow_706()
{
