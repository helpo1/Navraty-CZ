...
instance Sld_816_Fester(Npc_Default)
{
	...
	B_SetNpcVisual(self,MALE,"Hum_Head_FatBald",Face_N_NormalBart05,BodyTex_N,ITAR_SLD_L_V1);
...
func void rtn_farm_816()
{
	TA_Sit_Campfire(8,0,20,0,"NW_BIGFARM_VORPOSTEN1_01");
	TA_Sit_Campfire(20,0,8,0,"NW_BIGFARM_VORPOSTEN1_01");
};

func void rtn_inbattle_816()
{
	ta_bigfight(8,0,22,0,"NW_BIGFIGHT_8659");
	ta_bigfight(22,0,8,0,"NW_BIGFIGHT_8659");
};
