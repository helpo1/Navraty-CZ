...
var int isidro_itemsgiven_chapter_1;
var int isidro_itemsgiven_chapter_2;
var int isidro_itemsgiven_chapter_3;
var int isidro_itemsgiven_chapter_4;
var int isidro_itemsgiven_chapter_5;

func void b_givetradeinv_isidro(var C_Npc slf)
{
	if((Kapitel >= 1) && (ISIDRO_ITEMSGIVEN_CHAPTER_1 == FALSE))
	{
		...
		ISIDRO_ITEMSGIVEN_CHAPTER_1 = TRUE;
	};
	if((Kapitel >= 2) && (ISIDRO_ITEMSGIVEN_CHAPTER_2 == FALSE))
	{
		CreateInvItems(slf,ItMi_Gold,50);
		...
		ISIDRO_ITEMSGIVEN_CHAPTER_2 = TRUE;
	};
	if((Kapitel >= 3) && (ISIDRO_ITEMSGIVEN_CHAPTER_3 == FALSE))
	{
		...
		ISIDRO_ITEMSGIVEN_CHAPTER_3 = TRUE;
	};
	if((Kapitel >= 4) && (ISIDRO_ITEMSGIVEN_CHAPTER_4 == FALSE))
	{
		CreateInvItems(slf,ItMi_Gold,50);
		CreateInvItems(slf,ItPo_Speed,2);
		CreateInvItems(slf,itpo_speed_02,1);
		...
		CreateInvItems(slf,ItPl_Mana_Herb_02,3);
		CreateInvItems(slf,ItPl_Mana_Herb_03,3);
		ISIDRO_ITEMSGIVEN_CHAPTER_4 = TRUE;
	};
	if((Kapitel >= 5) && (ISIDRO_ITEMSGIVEN_CHAPTER_5 == FALSE))
	{
		CreateInvItems(slf,ItMi_Gold,50);
		CreateInvItems(slf,ItPo_Speed,2);
		CreateInvItems(slf,itpo_speed_02,1);
		...
		CreateInvItems(slf,ItPl_Mana_Herb_02,3);
		CreateInvItems(slf,ItPl_Mana_Herb_03,3);
		ISIDRO_ITEMSGIVEN_CHAPTER_5 = TRUE;
	};
};