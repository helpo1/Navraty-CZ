...
func void B_GiveTradeInv_Elena(var C_Npc slf)
{
	if((Kapitel >= 1) && (Elena_ItemsGiven_Chapter_1 == FALSE))
	{
		...
		CreateInvItems(slf,ItFo_Water,15);
		CreateInvItems(slf,ItFoMutton,25);
		...
		CreateInvItems(slf,ITMI_BROTSCHIEBER,5);
...
var int Assasin_ItemsGiven;

func void b_givetradeinv_Assasin(var C_Npc slf)
{
	if(Assasin_ItemsGiven == FALSE)
	{
