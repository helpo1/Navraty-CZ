...
func void DIA_Jack_DI_UndeadDragonDead_over()
{
	...
	AI_Output(other,self,"DIA_Jack_DI_UndeadDragonDead_over_15_00");	//Да! Давай отплывать.
	AI_Output(self,other,"DIA_Jack_DI_UndeadDragonDead_over_14_01");	//Если ты уверен, что у тебя все есть, тогда иди в каюту капитана и поспи там. Тебе это понадобиться.
	AI_StopProcessInfos(self);
};