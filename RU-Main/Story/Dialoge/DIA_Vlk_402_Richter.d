...
{
	AI_Output(self,other,"DIA_Richter_Taliasan_01_00");	//Что ты тут шляешься? Ты вообще кто? И кто тебя впустил сюда?!
	AI_Output(other,self,"DIA_Richter_Taliasan_01_01");	//Ну... я... это...
	AI_Output(self,other,"DIA_Richter_Taliasan_01_02");	//Вижу, что тебя даже толком и разговаривать не научили.
	AI_Output(self,other,"DIA_Richter_Taliasan_01_03");	//Сразу видно - ни достоинства, ни манер!
	if(other.guild == GIL_KDF)
	{
		AI_Output(self,other,"DIA_Richter_Taliasan_01_0A");	//И как тебя еще приняли в маги Огня - не понимаю...
	};
	AI_Output(other,self,"DIA_Richter_Taliasan_01_04");	//Пожалуй, мне следовало бы преподать тебе урок хорошего тона!
	AI_Output(self,other,"DIA_Richter_Taliasan_01_05");	//Что?! Ты мне еще и угрожать будешь?! Ха! Тоже мне, еще один Галлахад выискался!
	AI_Output(other,self,"DIA_Richter_Taliasan_01_06");	//Галлахад? А кто это?
	AI_Output(self,other,"DIA_Richter_Taliasan_01_07");	//Да, был у нас тут один такой умник. Думал, если он - маг, то ему все можно.
	AI_Output(self,other,"DIA_Richter_Taliasan_01_08");	//Ну и где он сейчас, спрашивается?!
	AI_Output(other,self,"DIA_Richter_Taliasan_01_09");	//Где?
	AI_Output(self,other,"DIA_Richter_Taliasan_01_10");	//Откуда мне знать? Выгнали взашей пару лет назад. И поделом ему!
	AI_Output(self,other,"DIA_Richter_Taliasan_01_11");	//Может, сейчас ошивается где-нибудь в портовом квартале среди разных отбросов общества. В общем, там ему самое место.
	AI_Output(self,other,"DIA_Richter_Taliasan_01_12");	//Поэтому, если не хочешь, чтобы с тобой поступили точно так же, - проваливай отсюда!
	AI_Output(self,other,"DIA_Richter_Taliasan_01_13");	//Здесь не место таким, как ты!
