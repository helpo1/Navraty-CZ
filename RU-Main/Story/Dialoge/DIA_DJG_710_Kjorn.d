...
func void DIA_Kjorn_SellInfos_Info()
{
	...
	AI_Output(self,other,"DIA_Kjorn_SellInfos_06_03");	//Хмм...(задумчиво) Трудно сказать! Но, думаю, полсотни золотых за каждую информацию, что ты получишь, будет нормально.
};
...
func void DIA_Kjorn_BuyInfos_Info()
{
	...
	AI_Output(self,other,"DIA_Kjorn_BuyInfos_06_01");	//Пятьдесят золотых!
	Info_ClearChoices(DIA_Kjorn_BuyInfos);
	Info_AddChoice(DIA_Kjorn_BuyInfos,"Это слишком дорого.",DIA_Kjorn_BuyInfos_HoldMoney);
