...
func void DIA_Malak_PALADINE_Info()
{
	...
	AI_Output(self,other,"DIA_Malak_PALADINE_08_02");	//Не так давно тут был даже целый отряд паладинов. Они пошли через проход! С тех пор я их больше не видел.
};
...
func void DIA_Malak_BACKTOBENGAR_Info()
{
	...
	if(MIS_BengarsHelpingSLD == LOG_SUCCESS)
	{
		...
		AI_Output(self,other,"DIA_Malak_BACKTOBENGAR_08_05");	//А может, скажешь, а?
