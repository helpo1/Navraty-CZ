...
func void DIA_Addon_Franco_EXIT_Info()
{
	...
	{
		AI_Output(self,other,"DIA_Addon_Franco_EXIT_08_00");	//Не потеряйся, или пойдешь на корм болотожорам.
		Franco_Exit = TRUE;
	};
...
instance DIA_Franco_PICKPOCKET(C_Info)
{
	...
	permanent = TRUE;
	description = "(Попытаться украсть его амулет)";
};
...
func void DIA_Addon_Franco_HaiSuccess_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_Franco_HaiSuccess_08_02");	//Итак, ты победил болотожоров. Следовательно, ты полезен... по крайней мере, полезнее, чем большинство местных бездельников.
