...
func void DIA_Rukhar_HOLERANDOLPH_Info()
{
	...
	AI_Output(self,other,"DIA_Rukhar_HOLERANDOLPH_12_02");	//Все кладут одинаковые ставки в горшок. Победитель забирает всё! Размер ставки зависит только от размера твоего кошелька.
...
func void DIA_Rukhar_RANDOLPHWILL_Info()
{
	...
	AI_Output(self,other,"DIA_Rukhar_RANDOLPHWILL_12_03");	//Хо,хо,хо...(смеется) Рендольф-хвастун?! Ну, хорошо. Почему бы и нет!
...
{
	AI_Output(other,self,"DIA_Rukhar_RANDOLPHWILL_10_15_00");	//Десять золотых.
...
{
	AI_Output(other,self,"DIA_Rukhar_RANDOLPHWILL_20_15_00");	//Двадцать.
...
{
	AI_Output(other,self,"DIA_Rukhar_RANDOLPHWILL_50_15_00");	//Пятьдесят!
...
{
	AI_Output(other,self,"DIA_Rukhar_RANDOLPHWILL_100_15_00");	//Сто!
