...
func void DIA_Fester_Together_Gold()
{
	...
	AI_Output(self,other,"DIA_Fester_Together_Gold_08_03");	//Хорошо. Я могу заплатить тебе пятьдесят золотых - это все, что у меня есть.
...
func void DIA_Fester_WasMitAbmachung_Info()
{
	...
	{
		AI_Output(self,other,"DIA_Fester_WasMitAbmachung_08_02");	//Ну, я мог бы тебе помочь стать одним из нас, но я этого делать не стану.
		AI_Output(other,self,"DIA_Fester_WasMitAbmachung_15_03");	//И почему же?!
		AI_Output(self,other,"DIA_Fester_WasMitAbmachung_08_04");	//Если я всем расскажу, что ты мне помог, мне дадут еще одно новое задание.
		AI_Output(self,other,"DIA_Fester_WasMitAbmachung_08_05");	//А ты ж понимаешь, что я этого не хочу, не так ли?
		AI_Output(self,other,"DIA_Fester_WasMitAbmachung_08_06");	//Да, не повезло, парень! Ты точно, найдешь себе кого-то, кто сможет помочь.
		B_LogEntry(TOPIC_FesterRauber,"Фестер надул меня! Он воспользовался моей помощью, чтобы просто выполнить свою работу и всего-лишь. И естественно помогать мне стать наемником он конечно же не будет! Надо бы проучить этого ублюдка...");
	}
	else
	{
		AI_Output(self,other,"DIA_Fester_WasMitAbmachung_08_07");	//Эй - ты хотел воспользоваться моим положением, а я немного воспользовался тобой.
		AI_Output(self,other,"DIA_Fester_WasMitAbmachung_08_08");	//Но посмотри на дело по-другому! Ты научился чему-то новому, а это уже что-то, правда ведь?
		B_LogEntry(TOPIC_FesterRauber,"Фестер надул меня! Он воспользовался моей помощью, чтобы просто выполнить свою работу и всего-лишь. И естественно никаких денег я от него не получу! Надо бы проучить этого ублюдка...");
	};
