...
instance DIA_MIL_325_MILIZ_TOARMSCITYGATE(C_Info)
{
	npc = Mil_325_Miliz;
	nr = 1;
	condition = dia_mil_325_miliz_toarmscitygate_condition;
	information = dia_mil_325_miliz_toarmscitygate_info;
	permanent = TRUE;
	important = TRUE;
};
...
func void DIA_Mil_325_Miliz_Pass_Yes()
{
	...
	AI_Output(self,other,"DIA_Mil_325_Miliz_Pass_Yes_12_01");	//Хорошо, тогда проходи!
