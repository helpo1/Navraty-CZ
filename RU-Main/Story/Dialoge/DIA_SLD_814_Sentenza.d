...
func void DIA_Sentenza_Hello_JustLooking()
{
	...
	AI_Output(self,other,"DIA_Sentenza_Hello_JustLooking_09_01");	//Таких как ты, здесь ожидают большие проблемы! Это ты мне заявляешь, что просто прогуливаешься?
...
func void B_Sentenza_SearchMe()
{
	...
	AI_Output(self,other,"DIA_Sentenza_Hello_SearchMe_09_10");	//Я хочу получить с тебя всего полсотни золотых - это стандартный сбор. Ты должен заплатить его всего один раз. Это ведь честно, правда?
};
...
{
	AI_Output(other,self,"DIA_Sentenza_RagnarDead_01_00");	//Что здесь произошло?
	AI_Output(self,other,"DIA_Sentenza_RagnarDead_01_01");	//(спокойно) Ты об этом придурке? Я всего лишь попросил у него стандартную плату за проход на ферму, а он в ответ ударил меня!
	AI_Output(self,other,"DIA_Sentenza_RagnarDead_01_02");	//Я вспылил и просто-напросто проткнул его мечом. А тебе-то что?
	AI_Output(other,self,"DIA_Sentenza_RagnarDead_01_03");	//Теперь уже ничего...
};
...
func void DIA_Sentenza_Vote_Info()
{
	...
	{
		AI_Output(self,other,"DIA_Sentenza_Vote_09_02");	//Хотя, почему бы и нет? Полсотни золотых - это разумная плата за мой голос, тебе так не кажется?
	...
	else
	{
		...
		AI_Output(self,other,"DIA_Sentenza_Vote_09_06");	//Полсотни монет. Это сбор, который тебе все равно пришлось бы заплатить.
		Sentenza_Wants50 = TRUE;
	};
};
...
instance DIA_Sentenza_Pay50(C_Info)
{
	...
	permanent = TRUE;
	description = "Вот твои полсотни золотых монет.";
};
...
{
	AI_Output(other,self,"DIA_Sentenza_Pay50_15_00");	//Вот твои полсотни золотых монет.
	...
	{
		AI_Output(self,other,"DIA_Sentenza_Pay50_09_02");	//Не пытайся обмануть меня. Полсотни золотых и ни монетой меньше! Понял?
	};
};
