...
func void dia_sek_8040_novize_noforever_info()
{
	...
	{
		AI_Output(self,other,"DIA_SEK_8040_Novize_NoForever_01_00");	//Не мешай мне работать!
		AI_StopProcessInfos(self);
	}
	else
	{
		AI_Output(self,other,"DIA_SEK_8040_Novize_NoForever_01_01");	//Отстань! Не мешай мне отдыхать...
		AI_StopProcessInfos(self);
	};
};
