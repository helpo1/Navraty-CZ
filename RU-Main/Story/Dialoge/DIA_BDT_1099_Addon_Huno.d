...
func void DIA_Addon_Huno_Armor_Info()
{
	...
	if(Huno_ArmorCheap == FALSE)
	{
		...
		{
			Info_AddChoice(DIA_Addon_Huno_Armor,"Доспех бандита (Цена: 2100 монет)",DIA_Addon_Huno_Armor_BUY);
		};
		if((MIS_Huno_Stahl == LOG_SUCCESS) && (HUNO_ARMORPERM_TWO == FALSE))
		{
			Info_AddChoice(DIA_Addon_Huno_Armor,"Тяжелый доспех бандита (Цена: 2400 монет)",dia_addon_huno_armor_buy2);
		};
	}
	else
	{
		...
		if(Huno_ArmorPerm == FALSE)
		{
			Info_AddChoice(DIA_Addon_Huno_Armor,"Доспех бандита (Цена: 1400 монет)",DIA_Addon_Huno_Armor_BUY);
		};
		if((MIS_Huno_Stahl == LOG_SUCCESS) && (HUNO_ARMORPERM_TWO == FALSE))
		{
			Info_AddChoice(DIA_Addon_Huno_Armor,"Тяжелый доспех бандита (Цена: 1700 монет)",dia_addon_huno_armor_buy2);
		};
	};
};
...
func void DIA_Addon_Huno_Armor_BUY()
{
	...
	{
		AI_Output(self,other,"DIA_Addon_Huno_Armor_Buy_06_02");	//Нет денег - нет кольчуги.
	};
	Info_ClearChoices(DIA_Addon_Huno_Armor);
};
