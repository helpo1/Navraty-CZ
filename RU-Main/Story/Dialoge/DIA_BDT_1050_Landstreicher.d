...
func void DIA_Landstreicher_HALLO_Info()
{
	...
	Info_AddChoice(DIA_Landstreicher_HALLO,"Я должен идти дальше.",DIA_Landstreicher_HALLO_weg);
	Info_AddChoice(DIA_Landstreicher_HALLO,"Где первый?",DIA_Landstreicher_HALLO_wo);
	Info_AddChoice(DIA_Landstreicher_HALLO,"Кто второй?",DIA_Landstreicher_HALLO_wer);
};
...
func void DIA_Landstreicher_HALLO_wer()
{
	...
	{
		AI_Output(self,other,"DIA_Landstreicher_HALLO_wer_09_03");	//Глянь только на твои нелепые лохмотья. Я бы не решился так выйти даже ночью. (смеется)
		Info_AddChoice(DIA_Landstreicher_HALLO,"Следи за своим языком.",DIA_Landstreicher_HALLO_wer_vorsicht);
	};
};
