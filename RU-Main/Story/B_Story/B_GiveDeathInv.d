...
func int B_GiveInvItems_ExtraLoot(var C_Npc giver,var C_Npc taker,var int itemInstance,var int amount)
{
...
func void B_GiveExtraLoot(var C_Npc self)
{
	if(Hlp_GetInstanceID(self) == Hlp_GetInstanceID(IlArah))
	{
		...
		else
		{
			...
			{
				CreateInvItems(self,ItMw_1H_IlArahBlade_Left,1);
				CreateInvItems(self,ItMw_1H_IlArahBlade_Right,1);
			};
		};

		CreateInvItems(self,ItMi_HaosAvatarStone,1);
	};
	if(Hlp_GetInstanceID(self) == Hlp_GetInstanceID(Sleeper_Old))
	{
		if((hero.guild == GIL_KDF) || (hero.guild == GIL_KDW) || (hero.guild == GIL_KDM) || (hero.guild == GIL_GUR) || (hero.guild == GIL_NDM) || (hero.guild == GIL_NDW) || (hero.guild == GIL_NOV))
		{
			CreateInvItems(self,ItPo_Sleeper,1);
		}
		else
		{
			if(hero.attribute[ATR_STRENGTH] >= hero.attribute[ATR_DEXTERITY])
			{
				B_GiveInvItems_ExtraLoot(self,hero,ItAr_Shield_05,1);
				CreateInvItems(self,ItPo_Perm_STR,1);
			}
			else
			{
				CreateInvItems(self,ItMw_Speer_05,1);
	...
	if(Hlp_GetInstanceID(self) == Hlp_GetInstanceID(WATERRITUALDEMON))
	{
		if((hero.guild == GIL_KDF) || (hero.guild == GIL_KDW) || (hero.guild == GIL_KDM) || (hero.guild == GIL_GUR) || (hero.guild == GIL_NDM) || (hero.guild == GIL_NDW) || (hero.guild == GIL_NOV))
		{
			B_GiveInvItems_ExtraLoot(self,hero,ItRu_AdanosBall,1);
		...
		else
		{
			if(hero.attribute[ATR_STRENGTH] >= hero.attribute[ATR_DEXTERITY])
			{
				...
				{
					CreateInvItems(self,ItMw_2H_DarkSoul,1);
				}
				else
				{
			...
			{
				CreateInvItems(self,ITRW_HAOS_BOW_01,1);
				CreateInvItems(self,ItPo_Perm_Health,1);
			};
		};
	...
	if(Hlp_GetInstanceID(self) == Hlp_GetInstanceID(Sleeper))
	{
		if((hero.guild == GIL_KDF) || (hero.guild == GIL_KDW) || (hero.guild == GIL_KDM) || (hero.guild == GIL_GUR) || (hero.guild == GIL_NDM) || (hero.guild == GIL_NDW) || (hero.guild == GIL_NOV))
		{
			CreateInvItems(self,ItPo_AncientPotion,1);
			CreateInvItems(self,ItPo_Perm_Health,1);
		}
		else
		{
			if(hero.attribute[ATR_STRENGTH] >= hero.attribute[ATR_DEXTERITY])
			{
				B_GiveInvItems_ExtraLoot(self,hero,ItAr_God_Helm,1);
				CreateInvItems(self,ItPo_Perm_Health,1);
			}
			else
			{
				B_GiveInvItems_ExtraLoot(self,hero,ITAR_ASGARD,1);
				CreateInvItems(self,ItPo_Perm_Health,1);
			};
		};
	};
	if(Hlp_GetInstanceID(self) == Hlp_GetInstanceID(Dragon_Undead))
	{
		if((hero.guild == GIL_KDF) || (hero.guild == GIL_KDW) || (hero.guild == GIL_KDM) || (hero.guild == GIL_GUR) || (hero.guild == GIL_NDM) || (hero.guild == GIL_NDW) || (hero.guild == GIL_NOV))
		{
			CreateInvItems(self,ITMW_2H_KMR_DAEMONSTAFF_01,1);
		...
		else
		{
			if(hero.attribute[ATR_STRENGTH] >= hero.attribute[ATR_DEXTERITY])
			{
				if(hero.HitChance[NPC_TALENT_2H] > hero.HitChance[NPC_TALENT_1H])
				{
					CreateInvItems(self,ITMW_2H_DRAGONMASTER,1);
				}
				else
				{
			...
			{
				CreateInvItems(self,ITRW_G3_DEMON_BOW_01,1);
				CreateInvItems(self,ItPo_Perm_DEX,1);
			};
		};
	...
	if(Hlp_GetInstanceID(self) == Hlp_GetInstanceID(DMT_1299_OberDementor_DI))
	{
		if((hero.guild == GIL_KDF) || (hero.guild == GIL_KDW) || (hero.guild == GIL_KDM) || (hero.guild == GIL_GUR) || (hero.guild == GIL_NDM) || (hero.guild == GIL_NDW) || (hero.guild == GIL_NOV))
		{
			CreateInvItems(self,ItAm_Irdorat,1);
			CreateInvItems(self,ItPo_Perm_Health,1);
		}
		else
		{
			if(hero.attribute[ATR_STRENGTH] >= hero.attribute[ATR_DEXTERITY])
			{
				CreateInvItems(self,ItAr_Helm_Blood,1);
			}
			else
			{
				CreateInvItems(self,ItMw_DemonSpear,1);
			};
	...
	if(Hlp_GetInstanceID(self) == Hlp_GetInstanceID(Dragon_Fire_Island))
	{
		if((hero.guild == GIL_KDF) || (hero.guild == GIL_KDW) || (hero.guild == GIL_KDM) || (hero.guild == GIL_GUR) || (hero.guild == GIL_NDM) || (hero.guild == GIL_NDW) || (hero.guild == GIL_NOV))
		{
			CreateInvItems(self,ItPo_DragonMind_Epic,1);
		}
		else
		{
			if(hero.attribute[ATR_STRENGTH] >= hero.attribute[ATR_DEXTERITY])
			{
				B_GiveInvItems_ExtraLoot(self,hero,ItBe_DragonBelt,1);
				CreateInvItems(self,ItMw_Berserkeraxt,1);
				CreateInvItems(self,ItPo_Perm_STR,1);
			}
			else
			{
				CreateInvItems(self,ItMw_1H_GoldBrand,1);
				CreateInvItems(self,ItPo_Perm_DEX,1);
			};
		};
	};
	if(Hlp_GetInstanceID(self) == Hlp_GetInstanceID(Dragon_Black))
	{
		if((hero.guild == GIL_KDF) || (hero.guild == GIL_KDW) || (hero.guild == GIL_KDM) || (hero.guild == GIL_GUR) || (hero.guild == GIL_NDM) || (hero.guild == GIL_NDW) || (hero.guild == GIL_NOV))
		{
			CreateInvItems(self,ITMW_2H_DRAGONSTAFF_01,1);
			CreateInvItems(self,ItPo_Perm_Mana,1);
		}
		else
		{
			if(hero.attribute[ATR_STRENGTH] >= hero.attribute[ATR_DEXTERITY])
			{
				B_GiveInvItems_ExtraLoot(self,hero,ItAr_Helm_Demon,1);
				CreateInvItems(self,ItPo_Perm_STR,1);
			}
			else
			{
				CreateInvItems(self,ITMW_1H_BLACKSWORD,1);
				CreateInvItems(self,ItPo_Perm_DEX,1);
			};
		};
	...
	if(Hlp_GetInstanceID(self) == Hlp_GetInstanceID(HaosDemon_Orcmine))
	{
		if((hero.guild == GIL_KDF) || (hero.guild == GIL_KDW) || (hero.guild == GIL_KDM) || (hero.guild == GIL_GUR) || (hero.guild == GIL_NDM) || (hero.guild == GIL_NDW) || (hero.guild == GIL_NOV))
		{
			CreateInvItems(self,ItPo_DemonBlood,1);
			CreateInvItems(self,ItPo_Perm_Health,1);
		}
		else
		{
			if(hero.attribute[ATR_STRENGTH] >= hero.attribute[ATR_DEXTERITY])
			{
				CreateInvItems(self,ItMw_DemonHand,1);
			}
			else
			{
				CreateInvItems(self,ItMw_ButcherSpeer,1);
			};
	...
	if(Hlp_GetInstanceID(self) == Hlp_GetInstanceID(HaosDemon_Psicamp))
	{
		if((hero.guild == GIL_KDF) || (hero.guild == GIL_KDW) || (hero.guild == GIL_KDM) || (hero.guild == GIL_GUR) || (hero.guild == GIL_NDM) || (hero.guild == GIL_NDW) || (hero.guild == GIL_NOV))
		{
			CreateInvItems(self,ItSc_Quake,1);
		...
		else
		{
			if(hero.attribute[ATR_STRENGTH] >= hero.attribute[ATR_DEXTERITY])
			{
				CreateInvItems(self,ITMW_1H_KMR_SNAKESWORD_01,1);
			}
			else
			{
				CreateInvItems(self,ITRW_KMR_DARKLONG_BOW_01,1);
			};
	...
	if(Hlp_GetInstanceID(self) == Hlp_GetInstanceID(senyak_demon))
	{
		if((hero.guild == GIL_KDF) || (hero.guild == GIL_KDW) || (hero.guild == GIL_KDM) || (hero.guild == GIL_GUR) || (hero.guild == GIL_NDM) || (hero.guild == GIL_NDW) || (hero.guild == GIL_NOV))
		{
			CreateInvItems(self,ItPo_Perm_Mana_M_Strong,1);
		}
		else
		{
			if(hero.attribute[ATR_STRENGTH] >= hero.attribute[ATR_DEXTERITY])
			{
				CreateInvItems(self,ITMW_1H_G3A_DAEMONBLADE_01,1);
				CreateInvItems(self,ItPo_Perm_STR,1);
			}
			else
			{
				CreateInvItems(self,ITRW_BOW_BONES,1);
				CreateInvItems(self,ItPo_Perm_DEX,1);
			};
		};
	...
	if(Hlp_GetInstanceID(self) == Hlp_GetInstanceID(Ghost_Uniq))
	{
		if((hero.guild == GIL_KDF) || (hero.guild == GIL_KDW) || (hero.guild == GIL_KDM) || (hero.guild == GIL_GUR) || (hero.guild == GIL_NDM) || (hero.guild == GIL_NDW) || (hero.guild == GIL_NOV))
		{
			CreateInvItems(self,ItRi_Izulg,1);
			CreateInvItems(self,ItPo_Perm_Mana,1);
		}
		else
		{
			if(hero.attribute[ATR_STRENGTH] >= hero.attribute[ATR_DEXTERITY])
			{
				B_GiveInvItems_ExtraLoot(self,hero,ItAr_SHVWarrior,1);
				CreateInvItems(self,ItPo_Perm_STR,1);
			}
			else
			{
				CreateInvItems(self,ITRW_HOLYBOW,1);
				CreateInvItems(self,ItPo_Perm_DEX,1);
			};
		};

		CreateInvItems(self,ItMi_Zeitspalt_Addon,2);
	};
	if(Hlp_GetInstanceID(self) == Hlp_GetInstanceID(Ass_130_CorGalomDemon))
	{
		if((hero.guild == GIL_KDF) || (hero.guild == GIL_KDW) || (hero.guild == GIL_KDM) || (hero.guild == GIL_GUR) || (hero.guild == GIL_NDM) || (hero.guild == GIL_NDW) || (hero.guild == GIL_NOV))
		{
			...
			{
				B_GiveInvItems_ExtraLoot(self,hero,ITAR_ASSASINS_DEMONMAGE,1);
			}
			else
			{
		...
		else
		{
			if(hero.attribute[ATR_STRENGTH] >= hero.attribute[ATR_DEXTERITY])
			{
				if(hero.guild == GIL_TPL)
				{
					CreateInvItems(self,ITMW_TAMPLIER_SPECIAL_2H_SWORD_5,1);
				}
				else
				{
					CreateInvItems(self,ItMw_2H_SharpTeeth,1);
				};
			}
			else
			{
				CreateInvItems(self,ITRW_KMR_SHADOWS_BOW_01,1);
			};
	...
	if(Hlp_GetInstanceID(self) == Hlp_GetInstanceID(Imarah))
	{
		if((hero.guild == GIL_KDF) || (hero.guild == GIL_KDW) || (hero.guild == GIL_KDM) || (hero.guild == GIL_GUR) || (hero.guild == GIL_NDM) || (hero.guild == GIL_NDW) || (hero.guild == GIL_NOV))
		{
			...
			{
				B_GiveInvItems_ExtraLoot(self,hero,ITAR_KDW_ADANOS,1);
			}
			else
			{
				CreateInvItems(self,ItSc_AdanosBall,1);
				CreateInvItems(self,ItPo_ElixirSHadow,1);
			};
		...
		else
		{
			if(hero.attribute[ATR_STRENGTH] >= hero.attribute[ATR_DEXTERITY])
			{
				CreateInvItems(self,ItMw_RuneAxeAncient,1);
			}
			else
			{
		...
		CreateInvItems(self,ItMi_MoonStone,1);
		CreateInvItems(self,ItAm_Imarah,1);
	};
	if(Hlp_GetInstanceID(self) == Hlp_GetInstanceID(pir_1398_addon_inextremo_announcer))
	{
		if(BEKILLMASTER == TRUE)
		{
			B_GiveInvItems_ExtraLoot(self,hero,itar_kil_sls,1);
			CreateInvItems(self,ItLs_BeltCandle,1);
		};
	};
	if(Hlp_GetInstanceID(self) == Hlp_GetInstanceID(AmasSah))
	{
		CreateInvItems(self,ItMw_1H_Ancient_Left,1);
	};
	if(Hlp_GetInstanceID(self) == Hlp_GetInstanceID(AmasRaf))
	{
		CreateInvItems(self,ItMw_1H_Ancient_Right,1);
	};
	if((hero.guild == GIL_PAL) && (Hlp_GetInstanceID(self) == Hlp_GetInstanceID(Skeleton_Lord_Ginnok)))
	{
		B_GiveInvItems_ExtraLoot(self,hero,ItAr_Pal_Elite_Helm,1);
	};
};

func void B_ClearNpcInventory(var C_Npc Trader)
{
	...
	if(Npc_HasItems(Trader,ItAt_DemonSkull) > 0)
	{
		Npc_RemoveInvItems(Trader,ItAt_DemonSkull,Npc_HasItems(Trader,ItAt_DemonSkull));
	};
	...
	if(Npc_HasItems(Trader,ITMW_1H_СREST) > 0)
	{
		Npc_RemoveInvItems(Trader,ITMW_1H_СREST,Npc_HasItems(Trader,ITMW_1H_СREST));
	};
...
func void B_GiveDeathInv(var C_Npc slf)
{
	...
	var int orc_gold;
	var int goblinmage_randomizer;
	var int Orc_Randomizer;
	var int orcwarriorgold;
	...
	{
		B_ClearNpcInventory(slf);
		return;
	};
	if((Hlp_GetInstanceID(slf) == Hlp_GetInstanceID(demon_sendsenyak)) || (Hlp_GetInstanceID(slf) == Hlp_GetInstanceID(SKELETONMAGE_SENDSENYAK_1)) || (Hlp_GetInstanceID(slf) == Hlp_GetInstanceID(SKELETONMAGE_SENDSENYAK_2)) || (Hlp_GetInstanceID(slf) == Hlp_GetInstanceID(SKELETONMAGE_SENDSENYAK_3)))
	{
		return;
	};	
	if((slf.aivar[AIV_MM_REAL_ID] == ID_SUMMONED_DEMON) || (slf.aivar[AIV_MM_REAL_ID] == ID_SUMMONED_WOLF) || (slf.aivar[AIV_MM_REAL_ID] == ID_SUMMONED_GOBBO_SKELETON) || (slf.aivar[AIV_MM_REAL_ID] == ID_SUMMONED_SKELETON_MAGE) || (slf.aivar[AIV_MM_REAL_ID] == ID_SUMMONED_SKELETON) || (slf.aivar[AIV_MM_REAL_ID] == ID_SummonedGuardian) || (slf.aivar[AIV_MM_REAL_ID] == ID_SummonedZombie) || (slf.aivar[AIV_MM_REAL_ID] == ID_SUMMONED_SWAMPDRONE) || (slf.aivar[AIV_MM_REAL_ID] == ID_SUMMONED_DRAGON) || (slf.aivar[AIV_MM_REAL_ID] == ID_SUMMONED_GOLEM))
	{
		if(slf.aivar[AIV_MM_REAL_ID] == ID_SUMMONED_SKELETON)
		{
			Npc_RemoveInvItems(slf,ItMw_1h_MISC_Sword,1);
		};
	...
	{
		if(Npc_HasItems(hero,ItMi_MeetKnife) >= 1)
		{
			...
			else if(slf.aivar[AIV_MM_REAL_ID] == ID_SCAVENGER)
			{
				CreateInvItems(slf,ItFoMuttonRaw,3);
			};
			...
			if((slf.aivar[AIV_MM_REAL_ID] == ID_ZIEGE) || (slf.aivar[AIV_MM_REAL_ID] == ID_BARAN))
			{
				CreateInvItems(slf,ItFoMuttonRaw,3);
			};
			if((Hlp_GetInstanceID(slf) == Hlp_GetInstanceID(Oster)) || (Hlp_GetInstanceID(slf) == Hlp_GetInstanceID(BLACKSNAPPER)) || (Hlp_GetInstanceID(slf) == Hlp_GetInstanceID(Snapper_Black_Osair_01)) || (Hlp_GetInstanceID(slf) == Hlp_GetInstanceID(Snapper_Black_Osair_02)) || (Hlp_GetInstanceID(slf) == Hlp_GetInstanceID(Snapper_Black_Osair_03)) || (Hlp_GetInstanceID(slf) == Hlp_GetInstanceID(Snapper_Black_Osair_04)) || (Hlp_GetInstanceID(slf) == Hlp_GetInstanceID(Snapper_Black_Osair_05)) || (Hlp_GetInstanceID(slf) == Hlp_GetInstanceID(Snapper_Black)))
			{
				CreateInvItems(slf,ItAt_BlackSnapperLiver,1);
			};
		}
		else
		{
	...
	if(slf.aivar[AIV_MM_REAL_ID] == ID_HARPY)
	{
		CreateInvItems(slf,ItMi_Nugget,1);
	};
	if((slf.guild == GIL_DRAGON) && (slf.aivar[AIV_MM_REAL_ID] != ID_DRAGON_UNDEAD) && (MIS_MonasterySecret == LOG_SUCCESS))
	{
		CreateInvItems(slf,ItMi_DragonStaffPiece_Eye,1);
	};
	if(PLAYER_TALENT_TAKEANIMALTROPHY[TROPHY_Teeth] == TRUE)
	{
		if((slf.aivar[AIV_MM_REAL_ID] == ID_WOLF) && (Hlp_GetInstanceID(slf) != Hlp_GetInstanceID(Crait)))
		{
		...
		if(slf.aivar[AIV_MM_REAL_ID] == ID_DESERTSHARK)
		{
			CreateInvItems(slf,ItAt_DesertSharkTeeth,1);
		};
		...
		if(slf.aivar[AIV_MM_REAL_ID] == ID_TROLL_BLACK_CAVE)
		{
			CreateInvItems(slf,ItAt_TrollTooth,4);
		};
		...
		if(slf.aivar[AIV_MM_REAL_ID] == ID_STONEPUMA)
		{
			CreateInvItems(slf,ItAt_Teeth,2);
		};
	};
	if(PLAYER_TALENT_TAKEANIMALTROPHY[TROPHY_Claws] == TRUE)
	{
		...
		if(slf.aivar[AIV_MM_REAL_ID] == ID_SCHILDKROETE)
		{
			CreateInvItems(slf,ItAt_Claw,2);
		};
		...
		if(slf.aivar[AIV_MM_REAL_ID] == ID_OREBUG)
		{
			CreateInvItems(slf,ItAt_OreBugClaw,2);
		};
		if(slf.aivar[AIV_MM_REAL_ID] == ID_STONEPUMA)
		{
			CreateInvItems(slf,ItAt_Claw,4);
	...
	{
		if(Hlp_GetInstanceID(slf) == Hlp_GetInstanceID(Rabbit))
		{
			CreateInvItems(slf,ItAt_RabbitFur,1);
		};
		if((slf.aivar[AIV_MM_REAL_ID] == ID_WOLF) && (Hlp_GetInstanceID(slf) != Hlp_GetInstanceID(Crait)))
		{
		...
		if(slf.aivar[AIV_MM_REAL_ID] == ID_WARG)
		{
			if(Hlp_GetInstanceID(slf) == Hlp_GetInstanceID(ORCDOG))
			{
				CreateInvItems(slf,ItAt_OrcDogFur,1);
			}
			else
			{
		...
		if(slf.aivar[AIV_MM_REAL_ID] == ID_SHADOWBEAST)
		{
			if((Hlp_GetInstanceID(slf) != Hlp_GetInstanceID(NIGHTHUNTER)) && (Hlp_GetInstanceID(slf) != Hlp_GetInstanceID(FIRETESTMONSTER_03)))
			{
		...
		if((slf.aivar[AIV_MM_REAL_ID] == ID_TROLL_BLACK_CAVE) && (Hlp_GetInstanceID(slf) != Hlp_GetInstanceID(TROLL_BLACK_AGE_PW)))
		{
			CreateInvItems(slf,ItAt_CaveBlackFurTroll,1);
		};	
		if(slf.aivar[AIV_MM_REAL_ID] == ID_TROLL_BLACK_ICE)
		{
			CreateInvItems(slf,ItAt_WhiteTroll,1);
		};
		if(slf.aivar[AIV_MM_REAL_ID] == ID_Keiler)
		{
			if(Hlp_GetInstanceID(slf) != Hlp_GetInstanceID(keiler_vepr))
			{
		...
		if(slf.aivar[AIV_MM_REAL_ID] == ID_STONEPUMA)
		{
			CreateInvItems(slf,itat_pumafur,1);
		};
		if(slf.aivar[AIV_MM_REAL_ID] == ID_ICEPUMA)
		{
			CreateInvItems(slf,ItAt_WhitePuma,1);
		};
		if(slf.aivar[AIV_MM_REAL_ID] == ID_BARAN)
		{
	...
	{
		if((slf.aivar[AIV_MM_REAL_ID] == ID_STONEGOLEM) && (Hlp_GetInstanceID(slf) != Hlp_GetInstanceID(StoneGolem_Dragon)) && (Hlp_GetInstanceID(slf) != Hlp_GetInstanceID(StoneGolem_Avatar)))
		{
			if(Hlp_GetInstanceID(slf) != Hlp_GetInstanceID(stonegolem_osta))
			{
				CreateInvItems(slf,ItAt_StoneGolemHeart,1);
			};
		};
		if((slf.aivar[AIV_MM_REAL_ID] == ID_FIREGOLEM) && (Hlp_GetInstanceID(slf) != Hlp_GetInstanceID(FireGolem_Dragon)) && (Hlp_GetInstanceID(slf) != Hlp_GetInstanceID(FireGolem_Avatar)))
		{
			if((Hlp_GetInstanceID(slf) != Hlp_GetInstanceID(firetestmonster_05)) && (Hlp_GetInstanceID(slf) != Hlp_GetInstanceID(FireGolem_LV)))
			{
				CreateInvItems(slf,ItAt_FireGolemHeart,1);
			};
		};
		if((slf.aivar[AIV_MM_REAL_ID] == ID_ICEGOLEM) && (Hlp_GetInstanceID(slf) != Hlp_GetInstanceID(IceGolem_Dragon)) && (Hlp_GetInstanceID(slf) != Hlp_GetInstanceID(IceGolem_Avatar)))
		{
			CreateInvItems(slf,ItAt_IceGolemHeart,1);
		};
		if((slf.aivar[AIV_MM_REAL_ID] == ID_Swampgolem) && (Hlp_GetInstanceID(slf) != Hlp_GetInstanceID(SwampGolem_Dragon)))
		{
			CreateInvItems(slf,itat_swampgolemheart,1);
		};
		if((slf.aivar[AIV_MM_REAL_ID] == ID_DEMON) && (Hlp_GetInstanceID(slf) != Hlp_GetInstanceID(DEMON_CHAOS)) && (Hlp_GetInstanceID(slf) != Hlp_GetInstanceID(DEMON_NOEXP)) && (Hlp_GetInstanceID(slf) != Hlp_GetInstanceID(DEMON_NONEEXP)))
		{
	...
	if((slf.aivar[AIV_MM_REAL_ID] == ID_ORCWARRIOR) || (slf.aivar[AIV_MM_REAL_ID] == ID_ORCSHAMAN) || (slf.aivar[AIV_MM_REAL_ID] == ID_ORCELITE) || (slf.aivar[AIV_MM_REAL_ID] == ID_ORCBOWMEN))
	{
		orc_gold = Hlp_Random(10);

		if(orc_gold < 5)
		{
			Npc_RemoveInvItems(slf,itfo_addon_orcrum,1);
		};
		if(slf.aivar[AIV_MM_REAL_ID] == ID_ORCBOWMEN)
		{
			Npc_RemoveInvItems(slf,ItRw_Bolt,Npc_HasItems(slf,ItRw_Bolt));
			CreateInvItems(slf,ItRw_Bolt,orc_gold);
		};
	};
	if(PLAYER_TALENT_TAKEANIMALTROPHY[TROPHY_ShadowHorn] == TRUE)
	{
		...
		if(slf.aivar[AIV_MM_REAL_ID] == ID_TROLL_BLACK_CAVE)
		{
			CreateInvItems(slf,ItAt_BlackTrollHorn,1);
		};
		if(slf.aivar[AIV_MM_REAL_ID] == ID_SHADOWBEAST_SKELETON)
		{
			CreateInvItems(slf,ItAt_ShadowHorn,1);
		};
	};
	...
	{
		if((slf.aivar[AIV_MM_REAL_ID] == ID_BLOODFLY) || (slf.aivar[AIV_MM_REAL_ID] == ID_SWAMPDRONE))
		{
	...
	if(PLAYER_TALENT_TAKEANIMALTROPHY[TROPHY_Mandibles] == TRUE)
	{
		...
		{
			if((Hlp_GetInstanceID(slf) != Hlp_GetInstanceID(Minecrawler_Mini)) && (Hlp_GetInstanceID(slf) != Hlp_GetInstanceID(PaleCrawler_Minion)))
			{
		...
		if(slf.aivar[AIV_MM_REAL_ID] == ID_SPIDER)
		{
			if(Hlp_GetInstanceID(slf) != Hlp_GetInstanceID(Spider_Tara))
			{
				CreateInvItems(slf,ItAt_SpiderMandibles,1);
			};
		};
	};
	...
	if(PLAYER_TALENT_TAKEANIMALTROPHY[TROPHY_DragonScale] == TRUE)
	{
		...
		if(Hlp_GetInstanceID(slf) == Hlp_GetInstanceID(blackdragon))
		{
			CreateInvItems(slf,ItAt_DragonScale,12);
		};
		if(Hlp_GetInstanceID(slf) == Hlp_GetInstanceID(golddragon))
		{
			CreateInvItems(slf,ItAt_DragonScale,12);
		};
		...
		if(Hlp_GetInstanceID(slf) == Hlp_GetInstanceID(UzDragon))
		{
			CreateInvItems(slf,ItAt_DragonScale,12);
		};
		if(Hlp_GetInstanceID(slf) == Hlp_GetInstanceID(DragonAV))
		{
			CreateInvItems(slf,ItAt_DragonScale,12);
		};
	};
	...
	{
		CreateInvItems(slf,ItMi_BokTree,2);
	};
	...
	if(slf.aivar[AIV_MM_REAL_ID] == ID_DRAGON_FIRE)
	{
		...
		CreateInvItems(slf,ItAt_XragonSkull,1);
	};
	if(slf.aivar[AIV_MM_REAL_ID] == ID_DRAGON_PW)
	{
		CreateInvItems(slf,ItAt_DragonHeart,1);
		CreateInvItems(slf,ItAt_XragonSkull,1);
	};
	...
	if(slf.aivar[AIV_MM_REAL_ID] == ID_DRAGON_RED)
	{
		CreateInvItems(slf,itat_reddragonheart,1);
		CreateInvItems(slf,ItAt_XragonSkull,1);
	};
	if(slf.aivar[AIV_MM_REAL_ID] == ID_DRAGON_BLACK)
	{
		CreateInvItems(slf,itat_blackdragonheart,1);
		CreateInvItems(slf,ItAt_XragonSkull,1);
	};
	if(slf.aivar[AIV_MM_REAL_ID] == ID_DRAGON_UZ)
	{
		CreateInvItems(slf,ItAt_uzdragonHeart,1);
		CreateInvItems(slf,ItAt_XragonSkull,1);
	};
	if(slf.aivar[AIV_MM_REAL_ID] == ID_DRAGON_GOLD)
	{
		if(KNOWS_CRESTMAKE == FALSE)
		{
			CreateInvItems(slf,itat_golddragonheart,1);
		};
	...
	{
		if(slf.aivar[AIV_StoryBandit] == FALSE)
		{
			CreateInvItems(slf,ItPo_Mana_03,1);
		};
	};
	if((slf.aivar[AIV_MM_REAL_ID] == ID_SKELETON) || (slf.aivar[AIV_MM_REAL_ID] == ID_SKELETON_LORD) || (slf.aivar[AIV_MM_REAL_ID] == ID_SKELETON_MAGE) || (slf.aivar[AIV_MM_REAL_ID] == ID_ZOMBIE_OM))
	{
		if((slf.aivar[AIV_StoryBandit] == FALSE) && (Hlp_GetInstanceID(slf) != Hlp_GetInstanceID(Ilarah)))
		{
			CreateInvItems(slf,ItAt_SkeletonBone,1);
		};
	};
	if((slf.aivar[AIV_MM_REAL_ID] == ID_ZOMBIE) && (Hlp_GetInstanceID(slf) != Hlp_GetInstanceID(Zombie_AraharPlague_01)) && (Hlp_GetInstanceID(slf) != Hlp_GetInstanceID(Zombie_AraharPlague_02)) && (Hlp_GetInstanceID(slf) != Hlp_GetInstanceID(Zombie_AraharPlague_03)) && (Hlp_GetInstanceID(slf) != Hlp_GetInstanceID(Zombie_AraharPlague_04)) && (Hlp_GetInstanceID(slf) != Hlp_GetInstanceID(Zombie_AraharPlague_05)) && (Hlp_GetInstanceID(slf) != Hlp_GetInstanceID(necromacerdemonzombie)))
	{
		CreateInvItems(slf,itmi_zombiecorpse,1);
	};
	if(slf.aivar[AIV_MM_REAL_ID] == ID_GHOST)
	{
		CreateInvItems(slf,itmi_plazma,1);
	};
	if(slf.aivar[AIV_MM_REAL_ID] == ID_BLATTCRAWLER)
	{
	...
	if(slf.aivar[AIV_MM_REAL_ID] == ID_GOBBO_GREEN)
	{
		...
		if(GoblinGreen_Randomizer <= 20)
		{
			CreateInvItems(slf,ItMi_SilverRing,1);
		}
		else if(GoblinGreen_Randomizer <= 40)
		{
			CreateInvItems(slf,ItPl_Mushroom_01,1);
		}
		else if(GoblinGreen_Randomizer <= 60)
		{
			CreateInvItems(slf,ItMi_Gold,5);
		}
		else if(GoblinGreen_Randomizer <= 80)
		{
	...
	if(slf.aivar[AIV_MM_REAL_ID] == ID_GOBBO_BLACK)
	{
		...
		Npc_RemoveInvItems(slf,ItMw_2H_Sword_M_01,1);
		Npc_RemoveInvItems(slf,ItMw_1h_Misc_Axe,1);

		if(GoblinBlack_Randomizer <= 20)
		{
			CreateInvItems(slf,ItMi_RingGold,1);
		}
		else if(GoblinBlack_Randomizer <= 40)
		{
			CreateInvItems(slf,ItFo_Fish,1);
		}
		else if(GoblinBlack_Randomizer <= 60)
		{
			CreateInvItems(slf,ItMi_Gold,10);
		}
		else if(GoblinBlack_Randomizer <= 80)
		{
	...
	if(slf.aivar[AIV_MM_REAL_ID] == ID_GOBBO_DESERT)
	{
		GoblinBlack_Randomizer = Hlp_Random(100);
		Npc_RemoveInvItems(slf,ItMw_2H_Sword_M_01,1);
		Npc_RemoveInvItems(slf,ItMw_1h_Misc_Axe,1);
		...
		{
			CreateInvItems(slf,ItMi_OldCoin,2);
		}
		else if(GoblinBlack_Randomizer <= 80)
		{
			CreateInvItems(slf,ItPl_Mushroom_02,1);
		...
		{
			CreateInvItems(slf,ItMi_OldCoin,1);
		};
	};

	orc_gold = 10 + Hlp_Random(20);

	if(slf.aivar[AIV_MM_REAL_ID] == ID_GOBBO_MAGE)
	{
		goblinmage_randomizer = Hlp_Random(100);
		Npc_RemoveInvItems(slf,ItMw_1h_Misc_Axe,1);

		if(goblinmage_randomizer <= 10)
		{
			CreateInvItems(slf,ItMi_RingGold,1);
			CreateInvItems(slf,ItMi_OldCoin,5);
		}
		else if(goblinmage_randomizer <= 20)
		{
			CreateInvItems(slf,ItFo_Bacon,3);
			CreateInvItems(slf,ItFo_Booze,2);
		}
		else if(goblinmage_randomizer <= 30)
		{
			CreateInvItems(slf,ItPl_Temp_Herb,1);
			CreateInvItems(slf,ItPl_Health_Herb_02,2);
		}
		else if(goblinmage_randomizer <= 40)
		{
			CreateInvItems(slf,ItMi_Gold,orc_gold);
			CreateInvItems(slf,ItPl_Mana_Herb_03,1);
		}
		else if(goblinmage_randomizer <= 50)
		{
			CreateInvItems(slf,ItPl_Mushroom_02,2);
		}
		else if(goblinmage_randomizer <= 60)
		{
			CreateInvItems(slf,ItMi_Gold,orc_gold);
	...
	if(slf.aivar[AIV_MM_REAL_ID] == ID_GOBBO_MAGE_DESERT)
	{
		goblinmage_randomizer = Hlp_Random(100);
		Npc_RemoveInvItems(slf,ItMw_1h_Misc_Axe,1);
		...
		{
			CreateInvItems(slf,ItMi_OldCoin,3);
			CreateInvItems(slf,ItPl_Mana_Herb_03,1);
		}
		else if(goblinmage_randomizer <= 50)
		{
	...
	if((Hlp_GetInstanceID(slf) == Hlp_GetInstanceID(gobbo_grandwarrior)) || (Hlp_GetInstanceID(slf) == Hlp_GetInstanceID(gobbo_grandwarrior_uniq)))
	{
		if(Hlp_GetInstanceID(slf) == Hlp_GetInstanceID(gobbo_grandwarrior_uniq))
		{
	...
	{
		orcwarriorgold = 2 + Hlp_Random(15);
		if(Orc_Randomizer == 0)
		{
			CreateInvItems(slf,ItMi_Gold,orcwarriorgold);
		}
	...
	if(slf.aivar[AIV_MM_REAL_ID] == ID_OGRE)
	{
		if(Orc_Randomizer == 0)
		{
			CreateInvItems(slf,ItMi_OldCoin,1);
	...
	{
		if((Orc_Randomizer >= 6) && ((Hlp_GetInstanceID(slf) == Hlp_GetInstanceID(orkelite_addon4)) || (Hlp_GetInstanceID(slf) == Hlp_GetInstanceID(orkelite_addon4r)) || (Hlp_GetInstanceID(slf) == Hlp_GetInstanceID(orkelite_addon4s)) || (Hlp_GetInstanceID(slf) == Hlp_GetInstanceID(OrkElite_AntiPaladinOrkOberst)) || (Hlp_GetInstanceID(slf) == Hlp_GetInstanceID(orkelite_adw_leader)) || (Hlp_GetInstanceID(slf) == Hlp_GetInstanceID(orkelite_general_nw)) || (Hlp_GetInstanceID(slf) == Hlp_GetInstanceID(orkelite_general_ow)) || (Hlp_GetInstanceID(slf) == Hlp_GetInstanceID(orkelite_addon4_chkflg_29)) || (Hlp_GetInstanceID(slf) == Hlp_GetInstanceID(orkelite_addon4_nwchkflg_01)) || (Hlp_GetInstanceID(slf) == Hlp_GetInstanceID(orkelite_addon4_nwchkflg_02)) || (Hlp_GetInstanceID(slf) == Hlp_GetInstanceID(orkelite_addon4_nwchkflg_03)) || (Hlp_GetInstanceID(slf) == Hlp_GetInstanceID(orkelite_addon4_chkflg_drakar_capitan)) || (Hlp_GetInstanceID(slf) == Hlp_GetInstanceID(orkelite_castle_01)) || (Hlp_GetInstanceID(slf) == Hlp_GetInstanceID(orkelite_castle_02)) || (Hlp_GetInstanceID(slf) == Hlp_GetInstanceID(orkelite_castle_03)) || (Hlp_GetInstanceID(slf) == Hlp_GetInstanceID(orkelite_castle_04)) || (Hlp_GetInstanceID(slf) == Hlp_GetInstanceID(orkelite_castle_05))))
		{
			if(PERMRAND == 3)
			{
				CreateInvItems(slf,ItMi_Gold,orc_gold);
	...
	if(slf.aivar[AIV_MM_REAL_ID] == ID_DEMENTOR)
	{
		if(Orc_Randomizer == 0)
		{
			CreateInvItems(slf,ItMi_RingGold,1);
	...
	if(slf.aivar[AIV_MM_REAL_ID] == ID_STONEPUMA)
	{
		if(PumaMuscule == FALSE)
		{
			CreateInvItems(slf,ItAt_PumaMuscle,1);
			PumaMuscule = TRUE;
		};
	};
	if((slf.aivar[AIV_MM_REAL_ID] == ID_DEMON_LORD) && (slf.aivar[90] == TRUE) && (summonavabul_once == TRUE) && (DemonSkullIsUp == FALSE))
	{
		CreateInvItems(slf,ItAt_DemonSkull,1);
		DemonSkullIsUp = TRUE;		
	};
	if((Hlp_GetInstanceID(slf) == Hlp_GetInstanceID(DEMON_CHAOS)) && (KratukHeartDone == FALSE))
	{
		CreateInvItems(slf,ItAt_KratukHeart,1);
		KratukHeartDone = TRUE;
	};
	if((slf.guild == GIL_MEATBUG) && (slf.aivar[AIV_MM_REAL_ID] == ID_Giant_Rat))
	{
