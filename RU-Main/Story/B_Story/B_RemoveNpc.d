func void B_ClearRemoveNpc(var C_Npc Trader)
{
...
func void B_RemoveNpc(var int npcInstance)
{
	...
	{
		AI_UnequipWeapons(npc);
		npc.flags = 0;
		npc.aivar[93] = FALSE;
		B_ClearRemoveNpc(npc);
...
func void B_RemoveMonster(var int npcInstance)
{
	var C_Npc npc;
	...
	if(Hlp_IsValidNpc(npc))
	{
		...
		npc.aivar[93] = FALSE;
		npc.wp = "TOT";
		npc.aivar[AIV_SummonTime] = TRUE;
		B_ClearRemoveNpc(npc);
		AI_Teleport(npc,"TOT");
	};
};

func void B_RemoveNpcQuarh(var int npcInstance)
{
	var C_Npc npc;
...
func void B_RemoveNpcKill(var int npcInstance)
{
	var C_Npc npc;
...
func void b_removenpcnodead(var int npcInstance)
{
	var C_Npc npc;
