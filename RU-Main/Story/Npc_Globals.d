...
var C_Npc Cronos_NW;
var C_Npc SATURAS_ADW;
var C_Npc MERDARION_ADW;
...
var C_Npc Hosh_Pak;
var C_Npc OW_FARROK;
var C_Npc OW_NURSHAK;
var C_Npc OW_TUMPAK;
var C_Npc OW_DURKASH;
var C_Npc Urshak;
var C_Npc Sengrath;
...
var C_Npc BLACKDRAGON;
var C_Npc GOLDDRAGON;
var C_Npc UzDragon;
...
var C_Npc GORNATOT;
var C_Npc GORNAVID;
var C_Npc SNSKELMAGE1;
var C_Npc SNSKELMAGE2;
var C_Npc SNSKELMAGE3;
var C_Npc SNDEMON;
var C_Npc SNDARKSKEL1;
var C_Npc SNDARKSKEL2;
var C_Npc SNSKEL1;
var C_Npc SNSKEL2;
var C_Npc SNSKEL3;
var C_Npc SNZOMBIE1;
...
var C_Npc MARCOS;
var C_Npc ALBERT;
var C_Npc ALBERT_GUARD1;
var C_Npc ALBERT_GUARD2;
var C_Npc ALBERT_GUARD3;
var C_Npc ALBERT_GUARD4;
var C_Npc ALBERT_GUARD5;
var C_Npc ALBERT_GUARD6;
var C_Npc MUD_GUARD1;
var C_Npc MUD_GUARD2;
var C_Npc MUD_GUARD3;
var C_Npc NATAN;
var C_Npc URHAN;
var C_Npc THORUS_NW;
var C_Npc SCATTY_NW;
...
func void B_InitNpcGlobals()
{
	...
	Fregeal = Hlp_GetNpc(NONE_1192_Fregeal);
	Kreol = Hlp_GetNpc(none_102_kreol);
	SleeperBoss = Hlp_GetNpc(SLEEPER_OLD);
	Kinjarts = Hlp_GetNpc(BDT_4568_KINJARTS);
	Ragnar = Hlp_GetNpc(STRF_8160_Ragnar);
	...
	BLACKDRAGON = Hlp_GetNpc(dragon_black);
	GOLDDRAGON = Hlp_GetNpc(none_103_dragon_gold);
	IceDragon = Hlp_GetNpc(Dragon_Ice);
	FireDragonIsland = Hlp_GetNpc(Dragon_Fire_Island);
	DragonAV = Hlp_GetNpc(Dragon_AV);
	...
	CAMPER_7501 = Hlp_GetNpc(xbs_7501_camper);
	NETBEK = Hlp_GetNpc(xbs_7507_netbek);
	GORNABAR = Hlp_GetNpc(xbs_7508_gornabar);
	RATFORD = Hlp_GetNpc(xbs_7510_ratford);
	TANDOR = Hlp_GetNpc(PAL_260_Tandor);
	OW_FARROK = Hlp_GetNpc(orc_8514_farrok);
	OW_NURSHAK = Hlp_GetNpc(orc_8515_nurshak);
	OW_TUMPAK = Hlp_GetNpc(orc_8516_tumpak);
	OW_DURKASH = Hlp_GetNpc(orc_8517_durkash);
	ALRIK = Hlp_GetNpc(VLK_438_Alrik);
	DARRION = Hlp_GetNpc(xbs_7513_darrion);
	EDDA = Hlp_GetNpc(VLK_471_Edda);
	BAALORUN = Hlp_GetNpc(gur_8002_orun);
	BAALTYON = Hlp_GetNpc(gur_8003_tyon);
	BAALPARVEZ = Hlp_GetNpc(gur_8004_parvez);
	BAALNAMIB = Hlp_GetNpc(gur_8036_namib);
	BAALCADAR = Hlp_GetNpc(gur_8037_cadar);
	NOVCAINE = Hlp_GetNpc(sek_8008_caine);
	NOVVIRAN = Hlp_GetNpc(sek_8009_viran);
	NOVHARLOK = Hlp_GetNpc(sek_8011_harlok);
	NOVTALAS = Hlp_GetNpc(sek_8012_talas);
	NOVJORU = Hlp_GetNpc(sek_8013_joru);
	NOVBALOR = Hlp_GetNpc(sek_8038_balor);
	GORNAKOSH = Hlp_GetNpc(tpl_8005_gornakosh);
	GORNATOT = Hlp_GetNpc(tpl_8006_gornatot);
	GORNAVID = Hlp_GetNpc(tpl_8007_gornavid);
	SNSKELMAGE1 = Hlp_GetNpc(skeletonmage_sendsenyak_1);
	SNSKELMAGE2 = Hlp_GetNpc(skeletonmage_sendsenyak_1);
	SNSKELMAGE3 = Hlp_GetNpc(skeletonmage_sendsenyak_3);
	SNDEMON = Hlp_GetNpc(demon_sendsenyak);
	SNDARKSKEL1 = Hlp_GetNpc(darkskeleton1_sendsenyak);
	SNDARKSKEL2 = Hlp_GetNpc(darkskeleton2_sendsenyak);
	SNSKEL1 = Hlp_GetNpc(skeleton1_sendsenyak);
	SNSKEL2 = Hlp_GetNpc(skeleton2_sendsenyak);
	SNSKEL3 = Hlp_GetNpc(skeleton3_sendsenyak);
	SNZOMBIE1 = Hlp_GetNpc(zombie1_sendsenyak);
	SNZOMBIE2 = Hlp_GetNpc(zombie2_sendsenyak);
	SNZOMBIE3 = Hlp_GetNpc(zombie3_sendsenyak);
	SNZOMBIE4 = Hlp_GetNpc(zombie4_sendsenyak);
	DRPYMONTE = Hlp_GetNpc(PIR_1390_Addon_InExtremo_DrPymonte);
	THEFLAIL = Hlp_GetNpc(PIR_1391_Addon_InExtremo_TheFlail);
	LUTTER = Hlp_GetNpc(PIR_1395_Addon_InExtremo_Lutter);
	FLEX = Hlp_GetNpc(PIR_1396_Addon_InExtremo_Flex);
	CHARLOTTE = Hlp_GetNpc(pir_1397_addon_inextremo_charlotte);
	ANNOUNCER = Hlp_GetNpc(pir_1398_addon_inextremo_announcer);
	FERDINANDMAN = Hlp_GetNpc(vlk_6135_ferdinandman);
	GASPAR = Hlp_GetNpc(vlk_6137_gaspar);
	HANNA = Hlp_GetNpc(VLK_414_Hanna);
	MUD = Hlp_GetNpc(none_116_mud);
	KURGANNW = Hlp_GetNpc(djg_7080_kurgan);
	KJORNNW = Hlp_GetNpc(djg_7100_kjorn);
	GODARNW = Hlp_GetNpc(djg_7110_godar);
	HOKURNNW = Hlp_GetNpc(djg_7120_hokurn);
	URHAN = Hlp_GetNpc(orc_8566_urhan);
	SATURAS_ADW = Hlp_GetNpc(KDW_14000_Addon_Saturas_ADW);
	MERDARION_ADW = Hlp_GetNpc(KDW_14050_Addon_Merdarion_ADW);
	NEFARIUS_ADW = Hlp_GetNpc(KDW_14020_Addon_Nefarius_ADW);
	THORUS_NW = Hlp_GetNpc(vlk_6022_thorus);
	SCATTY_NW = Hlp_GetNpc(vlk_6024_scatty);
	NATAN = Hlp_GetNpc(pal_9168_natan);
	Garond = Hlp_GetNpc(PAL_250_Garond);
	Oric = Hlp_GetNpc(PAL_251_Oric);
	Parcival = Hlp_GetNpc(PAL_252_Parcival);
	UDAR = Hlp_GetNpc(PAL_268_Udar);
	MARCOS = Hlp_GetNpc(PAL_217_Marcos);
	Marcos_Guard1 = Hlp_GetNpc(PAL_253_Wache);
	Marcos_Guard2 = Hlp_GetNpc(PAL_257_Ritter);
	ALBERT = Hlp_GetNpc(pal_7523_albert);
	ALBERT_GUARD1 = Hlp_GetNpc(pal_7518_ritter);
	ALBERT_GUARD2 = Hlp_GetNpc(pal_7519_ritter);
	ALBERT_GUARD3 = Hlp_GetNpc(pal_7520_ritter);
	ALBERT_GUARD4 = Hlp_GetNpc(pal_7521_ritter);
	ALBERT_GUARD5 = Hlp_GetNpc(pal_7522_ritter);
	ALBERT_GUARD6 = Hlp_GetNpc(pal_7524_ritter);
	MUD_GUARD1 = Hlp_GetNpc(pal_9165_ritter);
	MUD_GUARD2 = Hlp_GetNpc(pal_9166_ritter);
	MUD_GUARD3 = Hlp_GetNpc(pal_9167_ritter);
	...
	MIKA = Hlp_GetNpc(Mil_337_Mika);
	SNIPES = Hlp_GetNpc(bau_987_snipes);
	PW_Convoy = Hlp_GetNpc(SEK_168_SLAVEOBSSEK);
	PW_Betray = Hlp_GetNpc(SEK_156_SLAVEOBSSEK);
};

func void GKLDJkgjfkgjLDGJjfgkfdjgGDjgkl1()
{
};

func void GKLDJkgjfkgjLDGJjfgkfdjgGDjgkl()
{
};

func void GKLDJkgjfkgjLDGJjfgkfdjgGDjgklGHjdjggEUIERhKLSDHhfhd()
{
	GKLDJkgjfkgjLDGJjfgkfdjgGDjgkl();
	GKLDJkgjfkgjLDGJjfgkfdjgGDjgkl1();
};