...
const string Name_PaladinSpell = "Заклинание паладинов";
const string NAME_TPLSPELL = "Заклинание Стражей";
...
instance ITRU_ORCTELEPORT(C_Item)
{
	...
	text[0] = "Орочья руна телепортации...";
	text[1] = NAME_Manakosten;
	count[1] = SPL_Cost_Teleport;
	text[4] = "Телепортирует в зависимости от места нахождения...";
	inv_animate = 1;
};
...
instance ItRu_SumDemon(C_Item)
{
	...
	text[4] = "Позволяет вызывать низших демонов...";
	inv_animate = 1;
};
...
instance ItRu_SumDemon_01(C_Item)
{
	...
	count[3] = 1;
	text[4] = "Позволяет вызывать младших демонов...";
	inv_animate = 1;
};
...
instance ItRu_SumDemon_02(C_Item)
{
	...
	text[3] = NAME_Mag_Circle_Dem;
	count[3] = 2;
	text[4] = "Позволяет вызывать старших демонов...";
	inv_animate = 1;
};
...
instance ItRu_SumDemon_03(C_Item)
{
	...
	text[3] = NAME_Mag_Circle_Dem;
	count[3] = 3;
	text[4] = "Позволяет вызывать высших демонов...";
	inv_animate = 1;
};
...
instance ItRu_SumDemon_04(C_Item)
{
	...
	text[3] = NAME_Mag_Circle_Dem;
	count[3] = 4;
	text[4] = "Позволяет вызывать младших архидемонов...";
	inv_animate = 1;
};
...
instance ItRu_SumDemon_05(C_Item)
{
	...
	text[3] = NAME_Mag_Circle_Dem;
	count[3] = 5;
	text[4] = "Позволяет вызывать старших архидемонов...";
	inv_animate = 1;
};
...
instance ItRu_SumDemon_06(C_Item)
{
	...
	text[3] = NAME_Mag_Circle_Dem;
	count[3] = 6;
	text[4] = "Позволяет вызывать высших архидемонов...";
	inv_animate = 1;
};
...
instance ItRu_BreathOfDeath(C_Item)
{
	...
	text[0] = "Эта могущественная магическая руна содержит в себе";
	text[1] = "силу древнего клинка УРИЗЕЛЬ.";
...
instance ItRu_BeliarSuperRune(C_Item)
{
	...
	text[3] = "Эта руна хранит в себе дущу архидемона С'эньяка....";
	text[4] = "Символ в центре руны излучает темное свечение.";
	inv_animate = 1;
};
...
instance ItRu_TplHeal_03(C_Item)
{
	...
	count[3] = 100;
	text[4] = "Снимает все ослабляющие эффекты...";
	text[5] = "Временный иммунитет к эффектам контроля...";
	inv_animate = 1;
};
...
instance ItRu_MoraUlartu(C_Item)
{
	...
	text[3] = "Наделяет способностью порабощать души убитых врагов...";
...
instance ItRu_CrestElements(C_Item)
{
	...
	text[1] = "Древнее заклинание, вобравшее в себя силу всех стихий!";
	text[2] = "Способно уничтожить любое существо, включая бессмертных.";
...
instance ItRu_PyroRune(C_Item)
{
	...
	wear = WEAR_EFFECT;
	//effect = "SPELLFX_STONESPHERE";
	description = "Рунный камень Пирокара";
	text[4] = "Рунный камень переполняет магическая энергия...";
	inv_animate = 1;
};
...
instance ItRu_DestroyGuardians(C_Item)
{
	...
	text[1] = "Только обладающий могуществом богов сможет";
	text[2] = "использовать эту руну...";
	text[4] = NAME_Manakosten;
...
instance ItRu_SumTreant(C_Item)
{
	...
	wear = WEAR_EFFECT;
	//effect = "SPELLFX_GURUSTAFF";
	description = "Магический камень друидов";
	text[4] = "С его помощью можно вызвать стражей леса...";
	inv_animate = 1;
};
...
instance ItRu_EligorSummon(C_Item)
{
	...
	scemeName = "MAPSEALED";
	//effect = "SPELLFX_DARKLLIGHT";
	description = "Руна вызова";
	text[4] = "С его помощью можно призвать повелителя демонов, Элигора...";
...
{
	name = "Рунный камень телепортации";
	mainflag = ITEM_KAT_RUNE;
	flags = ITEM_MISSION;
	value = 10;
	...
	text[1] = NAME_Manakosten;
	count[1] = SPL_Cost_Teleport;
	text[4] = "Используется для телепортации...";
	inv_animate = 1;
};
...
instance ItRu_Unlock(C_Item)
{
	...
	text[4] = "Открывает замки только у сундуков...";
	inv_animate = 1;
};
