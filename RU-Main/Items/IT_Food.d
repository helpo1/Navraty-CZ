...
instance ItFo_Addon_Shellflesh(C_Item)
{
	...
	text[4] = "Внутри раковины нежное и сочное мясо...";
	text[5] = NAME_Value;
	count[5] = value;
	inv_animate = 1;
};
...
instance ItFo_Addon_Rum(C_Item)
{
	...
	count[1] = Mana_Rum;
	text[4] = "Белый душистый ром, мечта любого моряка...";
	text[5] = NAME_Value;
	count[5] = Value_Rum;
	inv_animate = 1;
};
...
instance ITFO_ADDON_ORCRUM(C_Item)
{
	...
	scemeName = "POTIONFAST";
	description = "Орочье пойло";
	text[3] = "Странный на вид, напиток орков...";
...
instance ITFO_ADDON_ORCRUMSAL(C_Item)
{
	...
	wear = WEAR_EFFECT;
	inv_animate = TRUE;
	description = "Зелье из орочьего пойла";
	text[3] = "Магическое зелье, сваренное из орочьего напитка...";
	text[4] = "Действие неизвестно...";
	text[5] = NAME_Value;
	count[5] = value;
	inv_animate = 1;
...
{
	name = "Эликсир из орочьего пойла";
	mainflag = ITEM_KAT_POTIONS;
	flags = ITEM_MULTI | ITEM_MISSION;
	value = 600;
	visual = "ItMi_Rum_03.3ds";
	...
	scemeName = "POTIONFAST";
	wear = WEAR_EFFECT;
	description = "Эликсир из орочьего пойла";
	text[3] = "Магический эликсир, сваренное из орочьего напитка...";
	text[4] = "Действие неизвестно...";
	text[5] = NAME_Value;
	count[5] = value;
	inv_animate = 1;
...
instance ItFo_Addon_Grog(C_Item)
{
	...
	count[2] = HP_Grog;
	text[4] = "Горячий напиток, приготовленный из рома...";
	text[5] = NAME_Value;
	count[5] = Value_Grog;
	inv_animate = 1;
};
...
instance ItFo_Addon_LousHammer(C_Item)
{
	...
	text[3] = "Очень крепкий алкогольный коктель, сваренный по особому рецепту...";
	text[4] = "Действие неизвестно...";
	text[5] = NAME_Value;
...
instance ItFo_Addon_SchlafHammer(C_Item)
{
	...
	scemeName = "POTIONFAST";
	description = "Двойной Молот Лу";
	text[3] = "Очень крепкий алкогольный коктель, способный свалить с ног любого...";
	text[4] = "Действие неизвестно...";
	text[5] = NAME_Value;
...
instance ItFo_Addon_SchnellerHering(C_Item)
{
	...
	scemeName = "POTIONFAST";
	description = name;
	text[2] = "Очень крепкий самогон, изготовленный пиратами...";
...
instance ItFo_Addon_Pfeffer_01(C_Item)
{
	...
	material = MAT_LEATHER;
	description = "Красный перец";
	text[3] = "Красный слезный перец, выращенный на южных островах...";
	text[4] = "Осторожно! Очень острый...";
	text[5] = NAME_Value;
	count[5] = value;
	inv_animate = 1;
};
...
instance ItFo_Addon_FireStew(C_Item)
{
	...
	description = "Пламенная нарезка с Молотом Лу";
	text[1] = NAME_Bonus_Str;
	count[1] = STR_FireStew;
	text[3] = "Пламенная нарезка, заправленная 'Молотом Лу'...";
	text[4] = "Осторожно! Очень острая...";
	text[5] = NAME_Value;
...
instance ItFo_BeetSoup(C_Item)
{
	...
	description = "Суп из репы";
	text[1] = NAME_Bonus_HP;
	count[1] = HP_BeetSoup;
	text[2] = NAME_BONUS_STAPROC;
	count[2] = 5;
	text[4] = "Вкусный дымящийся суп, сваренный из репы...";
	text[5] = NAME_Value;
	count[5] = 10;
};
...
instance ItFo_Addon_Meatsoup(C_Item)
{
	...
	description = "Мясной суп";
	text[1] = NAME_Bonus_Str;
	count[1] = STR_MeatSoup;
	text[4] = "Вкусный дымящийся суп, сваренный из мяса...";
	text[5] = NAME_Value;
...
instance ITFOMUTTON_NICLAS(C_Item)
{
	...
	count[3] = 15;
	text[4] = "Этот кусок мяса приготовлен по особому рецепту...";
	text[5] = NAME_Value;
	count[5] = Value_Meat;
	inv_animate = 1;
};
...
instance ItFo_Beer(C_Item)
{
	...
	text[3] = NAME_BONUS_STAPROC;
	count[3] = 5;
	text[4] = "Пиво 'Темный паладин', сваренное по особому рецепту...";
	text[5] = NAME_Value;
	count[5] = Value_Beer;
	inv_animate = 1;
};
...
instance ItMi_LoaWine(C_Item)
{
	...
	material = MAT_GLAS;
	description = name;
	text[4] = "Очень дорогой сорт вина...";
	text[5] = NAME_Value;
	count[5] = Value_Wine;
	inv_animate = 1;
};
...
instance ItPo_AssasinsRareWine(C_Item)
{
	...
	material = MAT_GLAS;
	description = name;
	text[4] = "Крайне редкое и очень дорогое вино...";
	text[5] = NAME_Value;
	count[5] = Value_Wine;
	inv_animate = 1;
};
...
{
	name = "Похлебка из мясных грибов";
	mainflag = ITEM_KAT_FOOD;
	flags = ITEM_MULTI | ITEM_MISSION;
	value = 125;
...
{
	name = "Похлебка из черных грибов";
	mainflag = ITEM_KAT_FOOD;
	flags = ITEM_MULTI | ITEM_MISSION;
	value = 180;
	visual = "ITFO_FISHSOUP_SKY.3ds";
...
instance ItFo_Meatbugragout(C_Item)
{
	...
	text[2] = NAME_Bonus_STAProc;
	count[2] = 10;
	text[4] = "Рагу из мясных жуков по 'снефски' с грибами и рисом...";
	text[5] = NAME_Value;
	count[5] = Value_Stew;
};
...
instance ItFo_BeliarTear(C_Item)
{
	...
	material = MAT_GLAS;
	description = name;
	text[4] = "Очень редкое и дорогое варантское вино...";
	text[5] = NAME_Value;
	count[5] = Value_Wine;
	inv_animate = 1;
};
...
instance ItFo_HildaStew(C_Item)
{
	...
	text[1] = NAME_Bonus_Str;
	count[1] = STR_FireStew;
	text[4] = "Этот суп для меня приготовила Хильда...";
	text[5] = NAME_Value;
	count[5] = Value_FireStew;
};
