...
const int FOLLOWTIME_FOREEVER = 9999;
...
const int AIV_RapidFirebolt_Combo = 30;
const int AIV_RapidIcebolt_Combo = 31;
const int AIV_SPL_Elevate_Dist = 32;
const int AIV_Elevator = 33;
const int AIV_RageStateTime = 34;
const int AIV_SPL_Elevate_State = 35;
...
const int ID_GOBBO_MAGE = 65;
const int ID_STONEPUMA = 66;
const int ID_SUMMONED_SWAMPDRONE = 67;
const int ID_MEATBUG_MANA = 68;
const int ID_MEATBUG_FOLLOWER = 69;
const int ID_DEMON_LUZIAN = 70;
const int ID_ORCBOWMEN = 71;
const int ID_DRAGON_BLACK = 72;
const int ID_DRAGON_RED = 73;
const int ID_ZOMBIE_OM = 74;
const int ID_DEMENTOR = 75;
const int ID_UNDEADORCSHAMAN = 76;
const int ID_DRAGON_GOLD = 77;
const int ID_ZOMBIE_GOMEZ = 78;
const int ID_SLEEPER = 79;
const int ID_ORCBF = 80;
const int ID_DEADMAGE = 81;
const int ID_SKELETON_LORD = 82;
const int ID_SCHILDKROETE = 83;
const int ID_DRAGON_UZ = 84;
const int ID_TROLL_BLACK_CAVE = 85;
const int ID_SUMMONED_DRAGON = 86;
const int ID_SKELETON_PRIEST = 87;
const int ID_DRAGON_PW = 88;
const int ID_CRAB = 89;
const int ID_SANDGOLEM = 90;
const int ID_NATTER = 91;
const int ID_ZIEGE = 92;
const int ID_OREBUG = 93;
const int ID_SLEEPER_OLD = 94;
const int ID_SPIDER = 95;
const int ID_ICEAVATAR = 96;
const int ID_FIREAVATAR = 97;
const int ID_STONEAVATAR = 98;
const int ID_HAOSAVATAR = 99;
const int ID_DESERTSHARK = 100;
const int ID_TROLL_BLACK_ICE = 101;
const int ID_ICEPUMA = 102;
const int ID_BARAN = 103;
const int ID_GHOST = 104;
const int ID_OGRE = 105;
const int ID_DARKGUARD = 106;
const int ID_SUMMONED_SKELETON_MAGE = 107;
const int ID_WoodGolem = 108;
const int ID_GOBBO_MAGE_DESERT = 109;
const int ID_GOBBO_DESERT = 110;
...
const int MAGIC_ALWAYS_MINE = 2;
const int AIV_DropDeadAndKill = 52;
const int AIV_FreezeNoHeal = 53;
...
const int AIV_SOULCAPTURE = 89;
const int AIV_BOSS = 90;
const int AIV_RAYNEWORK = 91;
const int AIV_DEADAWAKES = 92;
const int AIV_CANNODEAD = 93;
const int AIV_BONUSLP = 94;
const int AIV_BONUSLPGIVEN = 95;
const int AIV_STURMCREW = 96;
const int AIV_STURMCREWDONE = 97;
const int AIV_BEGINBIGBATTLE = 98;
const int AIV_STOPBIGBATTLE = 99;
...
var int petzcounter_coast_murder;
var int petzcounter_coast_theft;
var int petzcounter_coast_attack;
...
const int LOC_BL = 5;
const int LOC_ALL = 6;
const int LOC_COAST = 7;
const int LOC_PSICAMP = 8;
...
const int PERC_DIST_ORC_ACTIVE_MAX = 2200;
...
const int FIGHT_DIST_DRAGON_MAGIC = 350;
const int MONSTER_THREATEN_TIME = 1;
const int DRAGON_THREATEN_TIME = 4;
const int MONSTER_SUMMON_TIME = 100;
...
const int FIGHT_DIST_RANGED_OUTER = 800;
...
const int HAI_TIME_UNCONSCIOUS_ORC = 5;
...
const int FAI_SLEEPER = 48;
const int FAI_ELITEORC = 49;
const int TRUE = 1;
const int FALSE = 0;
...
const int NPCTYPE_CSP_AMBIENT = 8;
const int NPCTYPE_XBSAMBIENT = 9;
const int NPCTYPE_XBSMAIN = 10;
const int NPCTYPE_PALMORA = 11;
...
const int MOBSI_SHARPWEAPON = 8;
const int MOBSI_OREHACKEN = 9;
const int MOBSI_MAKEARROWS = 10;
const int MOBSI_TRSHACKEN = 11;
const int MOBSI_SMOKEWATERPIPE = 12;
const int MOBSI_POTIONJOINT = 13;
const int MOBSI_HIDDENFIND = 14;
const int MOBSI_IRONHACKEN = 15;
const int MOBSI_HERD = 16;
const int MOBSI_HERDPAN = 17;
const int MOBSI_SMITHFIRE = 18;
const int MOBSI_BOOKSHELF = 19;
const int MOBSI_MagicSmithWeapon = 20;
const int MOBSI_MagicOreFireGorn = 21;
const int MOBSI_Talk = 22;
const int MOBSI_TRINKFASS = 23;
const int MOBSI_MAKEBOWS = 24;
const int MOBSI_COOLBLADE = 25;
const int MOBSI_SKINRAPE = 26;
const int MOBSI_PRAYIDOL_HIDE = 27;
const int MOBSI_MEMORIES = 28;
const int MOBSI_POISONMOLERAT = 29;
const int MOBSI_TRFMAGIC = 30;
const int MOBSI_FIRECAMP = 31;
const int MOBSI_WELL = 32;
const int MOBSI_STEINDESWISSENS = 33;
const int MOBSI_PYRAMID_WRITE = 34;
const int MOBSI_PYRAMID_PASSWORD = 35;
const int MOBSI_ADANOSSCIP = 36;
const int MOBSI_ADANOSBRIDGE = 37;
const int MOBSI_KESSEL = 38;
...
const int BodyTex_Assasin = 9;
const int BodyTex_T = 10;
const int BodyTexBabe_F = 11;
const int BodyTexBabe_S = 12;
const int BODYTEX_GURU_P = 13;
const int BODYTEX_WORK_P = 14;
const int BODYTEX_WORX_P = 15;
const int BODYTEX_NEW_PLAYER = 16;
const int BodyTex_Masiaf_01 = 17;
const int BodyTex_Masiaf_02 = 18;
const int BodyTex_Prior_CorGalomDemon = 19;
const int BodyTex_Shadow_Demon = 20;
const int BodyTex_Prior_KorGalomDemon = 21;
const int BodyTex_RavenDemon = 22;
const int BodyTex_Guardians = 23;
const int BodyTex_Souls = 24;
...
const int Face_N_Normal_Olli_Kahn = 67; //Abigal'
...
const int Face_L_NormalBart_Rufus = 128; //Kassiya
const int Face_B_Guardian = 129;
...
const int FACE_N_ZOMBIEGOMEZ = 163;
const int FACE_N_WARRIORNATURE_1 = 164;
const int FACE_N_WARRIORNATURE_2 = 165;
const int FACE_N_IDOLORUN = 166;
const int FACE_N_SEKTANT_1 = 167;
const int FACE_N_CAINE = 168;
const int FACE_N_WARRIORNATURE_3 = 169;
const int FACE_N_SEKTANT_2 = 170;
const int FACE_N_HARLOK = 171;
const int FACE_N_TALAS = 172;
const int FACE_N_SEKTANT_3 = 173;
const int FACE_N_GORNATOT = 174;
const int FACE_N_JORU = 175;
const int FACE_N_IDOLNAMIB = 176;
const int FACE_N_IDOLTYON = 177;
const int FACE_N_IDOLPARVEZ = 178;
const int FACE_N_BALOR = 179;
const int FACE_N_SEKTANT_4 = 180;
const int FACE_N_SEKTANT_5 = 181;
const int FACE_N_SEKTANT_6 = 182;
const int FACE_N_IDOLCADAR = 183;
const int FACE_N_IDOLKORGALOM = 184;
const int FACE_N_GORNAKOSH = 185;
const int FACE_N_GORNAVID = 186;
const int FACE_N_VIRAN = 187;
const int FACE_N_TEMPLER_1 = 188;
const int FACE_N_FACE_N_SEKTANT_6 = 189;
const int FACE_N_TEMPLER_2 = 190;
const int FACE_N_TEMPLER_3 = 191;
const int FACE_N_TEMPLER_4 = 192;
const int FACE_N_TEMPLER_5 = 193;
const int FACE_N_KREOL = 194;
const int FACE_N_ABIGEIL = 195;
const int FACE_N_FALK = 196;
const int FACE_N_ZAHR = 197;
const int FACE_N_DEADPAL = 198;
const int Face_XG_Player = 199; //tatu razbitoye litso
const int Face_X_Player = 200;	//razbitoye litso
const int Face_NG_Player = 201;	//tatu
const int Face_NX_Player = 202;	//lysyy GG bez tatu
const int Face_XNG_Player = 203; //lysyy GG s tatu
const int Face_Assasin = 204;
const int Face_Masiaf_01 = 205;
const int Face_Masiaf_02 = 206;
const int Face_Masiaf_03 = 207;
const int Face_Masiaf_04 = 208;
const int Face_Prior_Rage = 209;
const int Face_Prior_Blind = 210;
const int Face_Prior_Rock = 211;
const int Face_Prior_Poison = 212;
const int Face_Prior_CorGalomDemon = 213;
const int Face_Shadow_Demon = 214;
const int Face_Masiaf_03_Demon = 215;
const int Face_Masiaf_01_Demon = 216;
const int Face_Masiaf_02_Demon = 217;

const int SPL_Cost_Teleport = 10;
const int SPL_Cost_Unlock = 100;
const int SPL_Cost_PalLight = 30;
const int SPL_Cost_PalHolyBolt = 30;
const int SPL_Cost_PalRepelEvil = 60;
const int SPL_Cost_PalDestroyEvil = 90;
...
const int SPL_Cost_Shrink = 150;
const int SPL_Damage_DESTROYUNDEAD = 1000;
const int SPL_Cost_OrcFireball = 50;
const int SPL_Damage_OrcFireball = 450;

//-----------------runy ognya--------------

const int SPL_Cost_Firebolt = 10;
const int SPL_COST_InstantFireball = 15;
const int SPL_Cost_InstantFireStorm = 30;
const int SPL_COST_ChargeFireball = 45;
const int SPL_COST_Firestorm = 40;
const int SPL_Cost_Explosion = 45;
const int SPL_COST_FIRELIGHT = 100;
const int SPL_Cost_Firerain = 250;
const int SPL_COST_MasterOfDisaster = 50;
const int SPL_Cost_FireMeteor = 60;
const int SPL_Cost_RapidFirebolt = 20;
...
const int SPL_Damage_Explosion = 400;
const int SPL_Damage_FireRain = 950;
const int SPL_Damage_FireMeteor = 750;
const int SPL_DAMAGE_MasterOfDisaster = 600;
const int SPL_Damage_RapidFirebolt = 70;

const int SPL_TimingCast_RapidFirebolt   = 2000; 
const int SPL_Timing_RapidFirebolt       = 800;  

const int SPL_Damage_FIRELIGHT = 25;
const int SPL_Radius_FireLight = 500;
const int SPL_Time_FireLight = 120;

const int SPL_Cost_MagicCage = 50;
...
const int SPL_Cost_AdanosBall = 50;
const int SPL_COST_SUMMONSHOAL = 100;
const int SPL_Cost_LightningFlash = 40;
const int SPL_Cost_Waterfist = 50;
const int SPL_Cost_Geyser = 60;
const int SPL_Cost_IceWave = 100;
const int SPL_Cost_Thunderstorm = 150;
const int SPL_Cost_RapidIcebolt = 30;

const int SPL_Damage_Zap = 40;
const int SPL_DAMAGE_Icebolt = 90;
const int SPL_DAMAGE_Icelance = 150;
const int SPL_DAMAGE_ICECUBE = 5;
const int SPL_Damage_ChargeZap = 175;
const int SPL_Damage_LightningFlash = 500;
const int SPL_DAMAGE_Waterfist = 700;
const int SPL_DAMAGE_ICEWAVE = 10;
const int SPL_DAMAGE_Geyser = 850;
const int SPL_DAMAGE_Thunderstorm = 900;
const int SPL_Damage_RapidIcebolt = 100;
const int SPL_DAMAGE_AdanosBall = 900;

const int SPL_TimingCast_RapidIcebolt = 2000;
const int SPL_Timing_RapidIcebolt = 800;
...
const int SPL_Cost_WindFist = 15;
const int SPL_Cost_Charm = 50;
const int SPL_Cost_Fear = 50;
const int SPL_Cost_Greententacle = 25;
const int SPL_COST_SEVEREFETIDITY = 50;
const int SPL_Cost_Acid = 35;
...
const int SPL_Cost_Quake = 200;
const int SPL_Cost_Extricate = 65;

const int SPL_DAMAGE_BERZERK = 50;
const int SPL_Damage_Windfist = 125;
const int SPL_DAMAGE_GREENTENTACLE = 10;
const int SPL_Damage_Extricate = 150;
const int SPL_Whirlwind_DAMAGE = 400;
const int SPL_Damage_Acid = 300;
const int SPL_DAMAGE_GuruWrath = 500;
const int SPL_Damage_Quake = 800;

const int SPL_Time_Acid = 8;
const int SPL_DmgPerSec_Acid = 2;

const int    SPL_Cost_Elevate = 10;
const int    SPL_STEP_Elevate =  6;
const int    SPL_STEPCOST_Elevate = 10;
const int    SPL_TOTALCOST_Elevate = 50;
...
const int   Elevate_Dist_max = 1144700928;
const int   Elevator_Earth = 0;
const int   Elevator_Stone = 1;
const int   Elevator_Platform = 2;
const int   Elevator_MAX = 3;

//-----------------runy t'my--------------

const int SPL_COST_Deathbolt = 10;
const int SPL_Cost_SummonGoblinSkeleton = 35;
const int SPL_Cost_SummonZombie = 50;
const int SPL_Cost_Swarm = 15;
const int SPL_Cost_SummonSkeleton = 100;
const int SPL_Cost_Lacerate = 15;
const int SPL_Cost_Energyball = 30;
const int SPL_Cost_SummonDemon = 150;
const int SPL_COST_Deathball = 50;
const int SPL_Cost_ArmyOfDarkness = 200;
const int SPL_Cost_MassDeath = 300;
const int SPL_Cost_Skull = 75;
const int SPL_Cost_Rage = 100;

const int SPL_DAMAGE_Deathbolt = 80;
const int SPL_Damage_Lacerate = 150;
...
const int SPL_Victims_Rage = 2; 

const int SPL_ManaForLife_RELATION = 1;
const int SPL_ManaForLife_MINHP = 1;
const int SPL_ManaForLife_MAXHP = 300;
const int SPL_ManaForLife_SAYTIME = 50;

//---------------runy strazhey-----------------------

const int SPL_COST_TPLLIGHTSTRIKE = 20;
const int SPL_COST_TPLMEDIUMSTRIKE = 40;
const int SPL_COST_TPLHEAVYSTRIKE = 60;
const int SPL_COST_TPLSUPERSTRIKE = 80;
const int SPL_DAMAGE_TPLLIGHTSTRIKE = 150;
const int SPL_DAMAGE_TPLMEDIUMSTRIKE = 300;
const int SPL_DAMAGE_TPLHEAVYSTRIKE = 450;
const int SPL_DAMAGE_TPLSUPERSTRIKE = 600;

//---------------------------------------------------

const int SPL_COST_DESTROYGUARDIANS = 200;
const int SPL_DAMAGE_DESTROYGUARDIANS = 1000;
const int SPL_FREEZE_DAMAGE = 5;
const int SPL_Cost_BreathOfDeath = 75;
const int SPL_COST_Concussionbolt = 100;
const int SPL_Cost_SummonGuardian = 100;
const int SPL_COST_SUMMONELIGOR = 300;
const int SPL_Damage_BreathOfDeath = 750;
const int SPL_DAMAGE_Concussionbolt = 500;
const int SPL_DAMAGE_CRESTELEMENTS = 9999;
const int STEP_ChargeFireball = 15;
const int STEP_ChargeZap = 15;
const int STEP_Firestorm = 20;
const int STEP_WindFist = 40;
const int SPL_TIME_Fear = 5;
const int SPL_TIME_Greententacle = 20;
const int SPL_TIME_FREEZE = 19;
const int SPL_TIME_FREEZE_SHORT = 5;
const int SPL_TIME_Inflate = 19;
const int SPL_TIME_SHORTZAPPED = 2;
const int SPL_TIME_Sleep = 30;
const int SPL_TIME_ManaForLife = 9;
const int SPL_TIME_Swarm = 5;
const int SPL_TIME_WHIRLWIND = 15;
const int SPL_Duration_PalLIGHT = 5;
const int SPL_Duration_LIGHT = 5;

const int SPL_Cost_PalLightHeal = 50;
const int SPL_Cost_PalMediumHeal = 75;
const int SPL_Cost_PalFullHeal = 100;

const int SPL_COST_TPLLIGHTHEAL = 25;
const int SPL_COST_TPLMEDIUMHEAL = 50;
const int SPL_COST_TPLHEAVYHEAL = 75;
const int SPL_COST_TPLSUPERHEAL = 100;

const int SPL_Cost_LightHeal = 100;
const int SPL_Cost_MediumHeal = 50;
const int SPL_Cost_FullHeal = 75;

const int SPL_ZAPPED_DAMAGE_PER_SEC = 2;
const int SPL_PYRO_DAMAGE_PER_SEC = 50;
const int SPL_CONTROL_DAMAGE_PER_SEC = 50;
const int SPL_TELEKINESIS_DAMAGE_PER_SEC = 5;
const int SPL_Inflate_Damage = 5;
const int SPL_Cost_Inflate = 10;
const int SPL_COST_BELIARSRUNE_01 = 15;
const int SPL_COST_BELIARSRUNE_02 = 30;
const int SPL_COST_BELIARSRUNE_03 = 45;
const int SPL_COST_BELIARSRUNE_04 = 60;
const int SPL_COST_BELIARSRUNE_05 = 75;
const int SPL_COST_BELIARSRUNE_06 = 90;
const int SPL_COST_BELIARSRUNE_SUPER = 105;
const int SPL_DAMAGE_BELIARSRUNE_01 = 150;
const int SPL_DAMAGE_BELIARSRUNE_02 = 300;
const int SPL_DAMAGE_BELIARSRUNE_03 = 450;
const int SPL_DAMAGE_BELIARSRUNE_04 = 600;
const int SPL_DAMAGE_BELIARSRUNE_05 = 750;
const int SPL_DAMAGE_BELIARSRUNE_06 = 1000;
const int SPL_DAMAGE_SUPERBELIARSRUNE = 1250;

const int SPL_Cost_TrfRuneBloodFly = 20;
const int SPL_Cost_TrfRuneWaran = 20;
const int SPL_Cost_TrfRuneWarg = 40;
const int SPL_Cost_TrfRuneShadowbeast = 60;
const int SPL_Cost_TrfRuneDragonSnapper = 80;
const int SPL_Cost_TrfRuneTroll = 100;

const int SPL_COST_TRFMEATBUG = 5;
const int SPL_Cost_TrfGiantRat = 5;
const int SPL_Cost_TrfScavenger = 10;
const int SPL_Cost_TrfWolf = 15;
const int SPL_Cost_TrfWaran = 15;
const int SPL_Cost_TrfLurker = 20;
const int SPL_Cost_TrfSnapper = 20;
const int SPL_Cost_TrfFireWaran = 30;
const int SPL_Cost_TrfWarg = 40;
const int SPL_Cost_TrfShadowbeast = 50;
const int SPL_Cost_TrfDragonSnapper = 60;
const int SPL_Cost_TrfGiantBug = 70;
const int SPL_Cost_TrfSheep = 50;
const int SPL_Cost_TrfTroll = 70;
const int SPL_Cost_TrfRune = 20;

const int SPL_MAGICBURN_DAMAGE_PER_SEC = 35;
const int SPL_MAGICBURNSHORT_DAMAGE_PER_SEC = 25;

const String Elevator_Visual[Elevator_MAX] =
{
    "MAGLIFT.3DS",  
    "MAGPILAR.3DS", 
    "MAGPLATE.MMS"  
};
const String Elevator_Sound[Elevator_MAX] =
{
    "STONE_SMALL",
    "ROPEWAY",      
    "STONE"
...
func void JFJHdjhfdFhdjFHDSFfdfs1()
{
};

func void JFJHdjhfdFhdjFHDSFfdfs()
{
};

func void JFJHdjhfdFhdjFHDSFfdfsJGjghf()
{
	JFJHdjhfdFhdjFHDSFfdfs();
	JFJHdjhfdFhdjFHDSFfdfs1();
};