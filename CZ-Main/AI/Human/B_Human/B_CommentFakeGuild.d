...
func void ZS_CommentFakeGuild()
{
	...
	if(Npc_HasEquippedArmor(other) == TRUE)
	{
		...
		else if((self.guild == GIL_NDW) || (self.guild == GIL_KDW))
		{
			B_Say(self,other,"$ADDON_WRONGARMOR_KDF");
		}
		else if((self.guild == GIL_NDM) || (self.guild == GIL_KDM))
		{
			B_Say(self,other,"$ADDON_WRONGARMOR_KDF");
		}
		...
		else if((self.guild == GIL_SEK) || (self.guild == GIL_TPL) || (self.guild == GIL_GUR))
		{
			B_Say(self,other,"$ADDON_WRONGARMOR_KDF");
		}
		else
