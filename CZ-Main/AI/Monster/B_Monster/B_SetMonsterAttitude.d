...
func void B_SetMonsterAttitude(var int fromGuild,var int attitude,var int toGuild)
{
	if(toGuild == GIL_SEPERATOR_HUM)
	{
		...
		Wld_SetGuildAttitude(fromGuild,attitude,GIL_SEK);
		Wld_SetGuildAttitude(fromGuild,attitude,GIL_TPL);
		Wld_SetGuildAttitude(fromGuild,attitude,GIL_NDW);
		Wld_SetGuildAttitude(fromGuild,attitude,GIL_NDM);
		Wld_SetGuildAttitude(fromGuild,attitude,GIL_KDM);
	}
	else if(fromGuild == GIL_SEPERATOR_HUM)
	{
		...
		Wld_SetGuildAttitude(GIL_SEK,attitude,toGuild);
		Wld_SetGuildAttitude(GIL_TPL,attitude,toGuild);
		Wld_SetGuildAttitude(GIL_NDW,attitude,toGuild);
		Wld_SetGuildAttitude(GIL_NDM,attitude,toGuild);
		Wld_SetGuildAttitude(GIL_KDM,attitude,toGuild);
	}
	else
	{
