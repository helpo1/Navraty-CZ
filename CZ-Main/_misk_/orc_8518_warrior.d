...
instance ORC_8518_WARRIOR(C_Npc)
{
	...
	daily_routine = rtn_start_8518;
};


func void rtn_start_8518()
{
	TA_Stand_Dementor(6,0,7,0,"NW_FOREST_PATH_79");
	TA_Stand_Dementor(7,0,8,0,"NW_FOREST_PATH_04_16");
	TA_Stand_Dementor(8,0,9,0,"NW_FOREST_PATH_79");
	TA_Stand_Dementor(9,0,10,0,"NW_FOREST_PATH_04_16");
	TA_Stand_Dementor(10,0,11,0,"NW_FOREST_PATH_79");
	TA_Stand_Dementor(11,0,12,0,"NW_FOREST_PATH_04_16");
	TA_Stand_Dementor(12,0,13,0,"NW_FOREST_PATH_79");
	TA_Stand_Dementor(13,0,14,0,"NW_FOREST_PATH_04_16");
	TA_Stand_Dementor(14,0,15,0,"NW_FOREST_PATH_79");
	TA_Stand_Dementor(15,0,16,0,"NW_FOREST_PATH_04_16");
	TA_Stand_Dementor(16,0,17,0,"NW_FOREST_PATH_79");
	TA_Stand_Dementor(17,0,18,0,"NW_FOREST_PATH_04_16");
	TA_Stand_Dementor(18,0,19,0,"NW_FOREST_PATH_79");
	TA_Stand_Dementor(19,0,20,0,"NW_FOREST_PATH_04_16");
	TA_Stand_Dementor(20,0,21,0,"NW_FOREST_PATH_79");
	TA_Stand_Dementor(21,0,22,0,"NW_FOREST_PATH_04_16");
	TA_Stand_Dementor(22,0,23,0,"NW_FOREST_PATH_79");
	TA_Stand_Dementor(23,0,0,0,"NW_FOREST_PATH_04_16");
	TA_Stand_Dementor(0,0,1,0,"NW_FOREST_PATH_79");
	TA_Stand_Dementor(1,0,2,0,"NW_FOREST_PATH_04_16");
	TA_Stand_Dementor(2,0,3,0,"NW_FOREST_PATH_79");
	TA_Stand_Dementor(3,0,4,0,"NW_FOREST_PATH_04_16");
	TA_Stand_Dementor(4,0,5,0,"NW_FOREST_PATH_79");
	TA_Stand_Dementor(5,0,6,0,"NW_FOREST_PATH_04_16");
};
