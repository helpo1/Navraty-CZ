...
const int Damage_Wolfsklinge = 21;
...
const int Condition_Misc2hSword = 40;
...
const int Range_Kriegskeule = 60;
...
const int Condition_Kriegshammer1 = 50;
const int Range_Kriegshammer1 = 70;
const int Value_Kriegshammer1 = 650;
const int Damage_Hellebarde = 60;
const int Condition_Hellebarde = 55;
const int Range_Hellebarde = 150;
const int Value_Hellebarde = 850;
...
const int Value_Piratensaebel = 400;
...
const int Damage_Common1_Sharp = 55;
const int Damage_Common1_Blade = 30;
const int Condition_Common1 = 30;
const int Range_Common1 = 90;
const int Value_Common1 = 200;
const int Value_Common1_Blade = 100;
const int Damage_RangerStaff = 60;
const int Condition_RangerStaff = 30;
const int Range_RangerStaff = 120;
const int Value_RangerStaff = 900;
const int Condition_Stab01 = 300;
const int Condition_Stab02 = 300;
const int Condition_Stab03 = 350;
const int Condition_Stab04 = 250;
const int Condition_StabDragon = 500;
const int Condition_StabDemon = 800;
const int Condition_StabBlood = 1200;
const int Range_Stab01 = 120;
const int Range_Stab02 = 120;
const int Range_Stab03 = 120;
const int Range_Stab04 = 120;
const int Damage_Stab01 = 50;
const int Damage_Stab02 = 40;
const int Damage_Stab03 = 45;
const int Damage_Stab04 = 35;
const int Value_Stab01 = 1900;
const int Value_Stab02 = 1850;
const int Value_Stab03 = 2000;
const int Value_Stab04 = 1950;
const int Damage_Stabkeule = 70;
const int Condition_Stabkeule = 70;
const int Range_Stabkeule = 120;
...
const int Damage_Schwert1_Sharp = 75;
const int Condition_Schwert1 = 50;
const int Range_Schwert1 = 70;
const int Value_Schwert1 = 400;
...
const int Damage_Schwert4_Sharp = 95;
const int Condition_Schwert4 = 70;
const int Range_Schwert4 = 80;
const int Value_Schwert4 = 600;
const int Damage_Special_1H_1 = 150;
const int Damage_Special_1H_2 = 170;
const int Damage_Special_1H_3 = 190;
const int Damage_Special_1H_4 = 215;
const int Damage_Special_2H_1 = 180;
const int Damage_Special_2H_2 = 240;
const int Damage_Special_2H_3 = 270;
const int Damage_Special_2H_4 = 300;
const int Condition_Special_1H_1 = 140;
const int Range_Special_1H_1 = 90;
const int Value_Special_1H_1 = 750;
const int Condition_Special_2H_1 = 160;
const int Range_Special_2H_1 = 100;
const int Value_Special_2H_1 = 900;
const int Condition_Special_1H_2 = 160;
const int Range_Special_1H_2 = 90;
const int Value_Special_1H_2 = 1200;
const int Condition_Special_2H_2 = 200;
const int Range_Special_2H_2 = 110;
const int Value_Special_2H_2 = 1500;
const int Condition_Special_1H_3 = 190;
const int Range_Special_1H_3 = 100;
const int Value_Special_1H_3 = 1500;
const int Condition_Special_2H_3 = 240;
const int Range_Special_2H_3 = 120;
const int Value_Special_2H_3 = 1800;
const int Condition_Special_1H_4 = 210;
const int Range_Special_1H_4 = 100;
const int Value_Special_1H_4 = 1800;
const int Condition_Special_2H_4 = 280;
const int Range_Special_2H_4 = 120;
const int Value_Special_2H_4 = 2100;
const int Damage_Rapier = 50;
const int Condition_Rapier = 60;
const int Range_Rapier = 70;
const int Value_Rapier = 100;
const int Damage_Rubinklinge = 100;
const int Damage_Rubinklinge_Sharp = 115;
const int Condition_Rubinklinge = 90;
const int Range_Rubinklinge = 90;
const int Value_Rubinklinge = 800;
...
const int Range_Zweihaender2 = 120;
...
const int Damage_Runenschwert = 120;
const int Condition_Runenschwert = 120;
...
const int Damage_ElBastardo_Sharp = 135;
const int Damage_Betty = 140;
const int Condition_ElBastardo = 110;
const int Range_ElBastardo = 100;
const int Value_ElBastardo = 1200;
const int Value_Betty = 2155;
const int Damage_Kriegshammer2 = 120;
const int Condition_Kriegshammer2 = 120;
const int Range_Kriegshammer2 = 80;
const int Value_Kriegshammer2 = 1200;
const int Damage_Meisterdegen = 110;
const int Condition_Meisterdegen = 90;
const int Range_Meisterdegen = 90;
const int Value_Meisterdegen = 2455;
...
const int Damage_Orkschlaechter = 190;
...
const int Damage_Schlachtaxt = 210;
...
const int Range_Sturmbringer = 120;
const int Value_Sturmbringer = 1500;
const int Damage_Berserkeraxt = 320;
const int Condition_Berserkeraxt = 350;
const int Range_Berserkeraxt = 90;
const int Value_Berserkeraxt = 3000;
const int Damage_Drachenschneide = 220;
const int Condition_Drachenschneide = 200;
const int Range_Drachenschneide = 120;
const int Value_Drachenschneide = 2900;
const int Damage_Blessed_1H_1 = 180;
const int Damage_Blessed_1H_2 = 200;
const int Damage_Blessed_1H_3 = 220;
const int Damage_Blessed_2H_1 = 240;
const int Damage_Blessed_2H_2 = 270;
const int Damage_Blessed_2H_3 = 300;
const int Damage_Blessed_2H_4 = 320;
const int Condition_Blessed_1H_1 = 100;
const int Range_Blessed_1H_1 = 100;
const int Value_Blessed_1H_1 = 100;
const int Condition_Blessed_1H_2 = 100;
const int Range_Blessed_1H_2 = 100;
const int Value_Blessed_1H_2 = 100;
const int Condition_Blessed_1H_3 = 100;
const int Range_Blessed_1H_3 = 100;
const int Value_Blessed_1H_3 = 100;
const int Condition_Blessed_2H_1 = 120;
const int Range_Blessed_2H_1 = 120;
const int Value_Blessed_2H_1 = 100;
const int Condition_Blessed_2H_2 = 120;
const int Range_Blessed_2H_2 = 120;
const int Value_Blessed_2H_2 = 100;
const int Condition_Blessed_2H_3 = 120;
const int Range_Blessed_2H_3 = 120;
const int Value_Blessed_2H_3 = 100;
const int Condition_Blessed_2H_4 = 140;
const int Range_Blessed_2H_4 = 120;
const int Value_Blessed_2H_4 = 100;

//--------------------dospekhi-----------------------------------------

const int VALUE_ITAR_NONE = 0;
const int VALUE_ITAR_PRISONEL = 15;
const int VALUE_ITAR_Prisoner = 30;
const int VALUE_ITAR_BauBabe_L = 60;
const int VALUE_ITAR_VlkBabe_L = 70;
const int VALUE_ITAR_Bau_L = 80;
const int VALUE_ITAR_Vlk_L = 90;
const int VALUE_ITAR_BauBabe_M = 100;
const int VALUE_ITAR_VlkBabe_M = 120;
const int VALUE_ITAR_Bau_M = 140;
const int VALUE_ITAR_Vlk_M = 160;
const int VALUE_ITAR_VlkBabe_H = 175;
const int VALUE_ITAR_Vlk_H = 200;
const int VALUE_ITAR_Barkeeper = 300;
const int VALUE_ITAR_Smith = 300;
const int VALUE_ITAR_ALCHEMY = 300;
const int VALUE_ITAR_Judge = 400;
const int VALUE_ITAR_MAGE = 450;
const int VALUE_ITAR_Governor = 500;
const int VALUE_ITAR_SEKBED = 150;
const int VALUE_ITAR_SEKBED_V1 = 200;
const int VALUE_ITAR_SMITH_NOV = 250;
const int PEDGE_ITAR_SMITH_NOV = 20;
const int VALUE_ITAR_Leather_L = 250;
const int VALUE_ITAR_ALCHEMY_NOV = 250;
const int VALUE_ITAR_KIL_SL = 500;
const int VALUE_ITAR_KIL_L = 1000;
const int VALUE_ITAR_MIL_L = 600;
const int VALUE_ITAR_MIL_L_V1 = 750;
const int VALUE_ITAR_SLD_L = 500;
const int VALUE_ITAR_SLD_L_V1 = 600;
const int VALUE_ITAR_SLD_M = 2000;
const int VALUE_ITAR_SLD_M_V1 = 2250;
const int VALUE_ITAR_SLP_L = 1000;
const int VALUE_ITAR_NOV_L = 700;
const int VALUE_ITAR_NDW_L = 850;
const int VALUE_ITAR_NDM_L = 800;
const int VALUE_ITAR_KDF_L = 1200;
const int VALUE_ITAR_KDF_M = 2500;
const int VALUE_ITAR_KDW_L_Addon = 1350;
const int VALUE_ITAR_DMT_L = 1500;
const int VALUE_ITAR_GUR_L = 1200;
const int VALUE_ITAR_RANGER_Addon = 1300;
const int VALUE_ITAR_RANGER_ADDON_V1 = 1600;
const int VALUE_ITAR_PIR_L_Addon = 1700;
const int VALUE_ITAR_PIR_M_Addon = 2000;
const int VALUE_ITAR_PIR_H_Addon = 2500;
const int VALUE_ITAR_BDT_M = 1750;
const int VALUE_ITAR_BDT_H = 2100;
const int VALUE_ITAR_BDT_F = 2400;
const int VALUE_ITAR_Diego = 1850;
const int VALUE_ITAR_DIEGO_V1 = 2150;
const int VALUE_ITAR_Bloodwyn_Addon = 2100;
const int VALUE_ITAR_BLOODWYN_ADDON_V1 = 2400;
const int VALUE_ITAR_Thorus_Addon = 2600;
const int VALUE_ITAR_THORUS_ADDON_V1 = 2900;
const int VALUE_Itar_OreBaron_Addon = 3200;
const int VALUE_ITAR_GOMEZ_ADDON = 3500;
const int VALUE_ITAR_DJG_Crawler = 1700;
const int VALUE_ITAR_MIL_M = 2500;
const int VALUE_ITAR_MIL_M_V1 = 3000;
const int VALUE_ITAR_SLD_H = 2500;
const int VALUE_ITAR_SLD_H_V1 = 2800;
const int VALUE_ITAR_PAL_M = 5000;
const int VALUE_ITAR_PAL_M_V1 = 7500;
const int VALUE_ITAR_PAL_M_V2 = 10000;
const int VALUE_ITAR_PAL_H = 15000;
const int VALUE_ITAR_PAL_H_V1 = 17500;
const int VALUE_ITAR_PAL_H_V2 = 20000;
const int VALUE_ITAR_DJG_L = 4000;
const int VALUE_ITAR_DJG_L_V1 = 6000;
const int VALUE_ITAR_DJG_M = 12000;
const int VALUE_ITAR_DJG_M_V1 = 14500;
const int VALUE_ITAR_DJG_H = 16000;
const int VALUE_ITAR_DJG_H_V1 = 20000;
const int VALUE_ITAR_KDF_H = 10000;
const int VALUE_ITAR_KDF_SH = 10000;
const int VALUE_ITAR_KDW_H = 10000;
const int VALUE_ITAR_DMT_H = 9000;
const int VALUE_ITAR_GUR_H = 9000;
const int VALUE_ITAR_TPL_L = 1500;
const int VALUE_ITAR_TPL_L_V1 = 3000;
const int VALUE_ITAR_TPL_M = 9500;
const int VALUE_ITAR_TPL_M_V1 = 12000;
const int VALUE_ITAR_TPL_S = 14000;
const int VALUE_ITAR_TPL_S_V1 = 17000;
const int VALUE_ITAR_DHT_M = 4500;
