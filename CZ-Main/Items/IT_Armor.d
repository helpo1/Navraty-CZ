...
instance ITAR_PAL_H_V13(ITAR_PAL_H_A)
{
	...
	description = name;
	//text[0] = NAME_Str_needed;
	text[0] = "Požadovaná síla: 240 | Požadovaná výdrž: 700";
	//count[0] = cond_value[2];
	text[1] = NAME_Prot_Edge;
	count[1] = protection[PROT_EDGE];
	text[2] = NAME_Prot_Blunt;
...
instance ITAR_PAL_H_V14(ITAR_PAL_H_A)
{
	...
	description = name;
	//text[0] = NAME_Str_needed;
	text[0] = "Požadovaná síla: 250 | Požadovaná výdrž: 700";
	//count[0] = cond_value[2];
	text[1] = NAME_Prot_Edge;
	count[1] = protection[PROT_EDGE];
	text[2] = NAME_Prot_Blunt;
...
instance ITAR_PAL_H_V15(ITAR_PAL_H_A)
{
	...
	description = name;
	//text[0] = NAME_Str_needed;
	text[0] = "Požadovaná síla: 270 | Požadovaná výdrž: 750";
	//count[0] = cond_value[2];
	text[1] = NAME_Prot_Edge;
	count[1] = protection[PROT_EDGE];
	text[2] = NAME_Prot_Blunt;
...
{
	name = "Těžká kovaná zbroj drakobijce";
	...
	description = name;
	//text[0] = NAME_Str_needed;
	text[0] = "Požadovaná síla: 250 | Požadovaná výdrž: 800";
	//count[0] = cond_value[2];
	text[1] = NAME_Prot_Edge;
	count[1] = protection[PROT_EDGE];
	text[2] = NAME_Prot_Blunt;
...
instance ITAR_DJG_H_V2(ITAR_DJG_H_A)
{
	...
	description = name;
	//text[0] = NAME_Str_needed;
	text[0] = "Požadovaná síla: 270 | Požadovaná výdrž: 850";
	//count[0] = cond_value[2];
	text[1] = NAME_Prot_Edge;
	count[1] = protection[PROT_EDGE];
	text[2] = NAME_Prot_Blunt;
...
instance ITAR_DJG_H_V3(ITAR_DJG_H_A)
{
	...
	description = name;
	//text[0] = NAME_Str_needed;
	text[0] = "Požadovaná síla: 280 | Požadovaná výdrž: 850";
	//count[0] = cond_value[2];
	text[1] = NAME_Prot_Edge;
	count[1] = protection[PROT_EDGE];
	text[2] = NAME_Prot_Blunt;
...
instance ITAR_DJG_H_V4(ITAR_DJG_H_A)
{
	...
	description = name;
	//text[0] = NAME_Str_needed;
	text[0] = "Požadovaná síla: 290 | Požadovaná výdrž: 850";
	//count[0] = cond_value[2];
	text[1] = NAME_Prot_Edge;
	count[1] = protection[PROT_EDGE];
	text[2] = NAME_Prot_Blunt;
...
instance ITAR_TPL_L_V4(ITAR_TPL_L_A)
{
	...
	description = name;
	//text[0] = NAME_Str_needed;
	text[0] = "Požadovaná síla: 65 | Požadovaná výdrž: 200";
	//count[0] = cond_value[2];
	text[1] = NAME_Prot_Edge;
	count[1] = protection[PROT_EDGE];
	text[2] = NAME_Prot_Blunt;
...
{
	name = "Roucho vysokého mága Temnoty";
	mainflag = ITEM_KAT_ARMOR;
	flags = ITEM_MISSION;
	protection[PROT_EDGE] = 90;
	protection[PROT_BLUNT] = 80;
...
{
	name = "Znesvěcené roucho vysokého mága Temnoty";
	mainflag = ITEM_KAT_ARMOR;
	flags = ITEM_MISSION;
	protection[PROT_EDGE] = 100;
	protection[PROT_BLUNT] = 90;
...
instance ITAR_Raven_Addon(C_Item)
{
	...
	description = name;
	//text[0] = NAME_Str_needed;
	text[0] = "Požadovaná obratnost: 500 | Požadovaná výdrž: 600";
	//count[0] = cond_value[2];
	text[1] = NAME_Prot_Edge;
	count[1] = protection[PROT_EDGE];
	text[2] = NAME_Prot_Blunt;
...
{
	name = "Zbroj přízračného válečníka";
	mainflag = ITEM_KAT_ARMOR;
	flags = ITEM_MISSION;
	protection[PROT_EDGE] = 130;
	protection[PROT_BLUNT] = 130;
...
{
	name = "Těžká zbroj stína Masyafu";
	mainflag = ITEM_KAT_ARMOR;
	flags = ITEM_MISSION;
	protection[PROT_EDGE] = 150;
	protection[PROT_BLUNT] = 110;
...
{
	name = "Kroužková zbroj nemrtvého Stína";
	mainflag = ITEM_KAT_ARMOR;
	flags = ITEM_MISSION;
	protection[PROT_EDGE] = 70;
	protection[PROT_BLUNT] = 70;
...
{
	name = "Lehká zbroj nemrtvé stráže";
	mainflag = ITEM_KAT_ARMOR;
	flags = ITEM_MISSION;
	protection[PROT_EDGE] = 70;
	protection[PROT_BLUNT] = 70;
...
{
	name = "Těžká zbroj nemrtvé stráže";
	mainflag = ITEM_KAT_ARMOR;
	flags = ITEM_MISSION;
	protection[PROT_EDGE] = 90;
	protection[PROT_BLUNT] = 90;
...
{
	name = "Roucho prokletého nejvyššího kněze";
	mainflag = ITEM_KAT_ARMOR;
	flags = ITEM_MISSION;
	protection[PROT_EDGE] = 120;
	protection[PROT_BLUNT] = 120;
...
instance ITAR_ORCARMOR(C_Item)
{
	...
	description = name;
	//text[0] = NAME_Str_needed;
	text[0] = "Požadovaná síla: 300 | Požadovaná výdrž: 650";
	//count[0] = cond_value[2];
	text[1] = NAME_Prot_Edge;
	count[1] = protection[PROT_EDGE];
	text[2] = NAME_Prot_Blunt;
