...
const int XP_Addon_MorgansRing = 300;
...
const int XP_Addon_BeliarsWeaponAbgegeben = 2500;
...
var int XP_Ambient;
const int XP_AmbientKap1 = 100;
const int XP_AmbientKap2 = 200;
const int XP_AmbientKap3 = 300;
const int XP_AmbientKap4 = 400;
const int XP_AmbientKap5 = 500;
const int XP_AmbientKap6 = 600;
const int XP_Book_Level_1 = 75;
const int XP_Book_Level_2 = 100;
const int XP_Book_Level_3 = 150;
const int XP_Bookstand = 50;
const int XP_BanditWeg = 100;
const int XP_Schuldenbuch = 300;
const int XP_BringOldCoin = 10;
const int XP_InnosSegen = 50;
const int XP_LobartHolRueben = 50;
const int XP_HildaHolPfanne = 50;
const int XP_MalethKillBandits = 150;
const int XP_VinoWein = 50;
const int XP_PayForGritta = 100;
const int XP_Matteo_Gold = 100;
const int XP_AlriksSword = 100;
const int XP_Baltram_ScoutAkil = 150;
...
const int XP_Andre_Auslieferung = 150;
...
const int XP_Garvell_Infos = 100;
const int XP_Bartok_Deal = 100;
...
const int XP_CASSIAGOLDCUP = 750;
...
const int XP_NEORASMAIL = 500;
const int XP_MardukBeten = 100;
...
const int XP_Garond_KilledDragon = 1000;
...
const int XP_WALKWITHCOOKTOFORESTCAMP = 850;
const int XP_RAVENRING = 200;
const int XP_FISKRETFORD = 200;
const int XP_MIS_FINDEDOCGROUP = 300;
const int XP_NETBEKGREATWORK = 400;
const int XP_SARARETURN = 300;
