...
{
	TA_Sit_Chair(8,0,20,0,"NW_LIGHTHOUSE_IN_02");
	TA_Sleep(20,0,8,0,"NW_LIGHTHOUSE_IN_03");
};

func void rtn_teach_457()
{
	TA_Stand_Guarding(7,0,21,0,"NW_CITY_SMITH_02");
	TA_Stand_Guarding(21,0,7,0,"NW_CITY_SMITH_02");
};
