...
instance Mil_359_Miliz(Npc_Default)
{
	name[0] = NAME_Miliz;
	guild = GIL_MIL;
	id = 359;
	...
	daily_routine = Rtn_Start_359;
};

func void Rtn_Start_359()
{
	TA_Stand_ArmsCrossed(7,0,20,58,"NW_CITY_HABOUR_KASERN_ARMORY_IN");
	TA_Stand_ArmsCrossed(20,58,0,0,"NW_CITY_HABOUR_KASERN_ARMORY_IN");
	TA_Stand_ArmsCrossed(0,0,7,0,"NW_CITY_HABOUR_KASERN_ARMORY_IN");
};