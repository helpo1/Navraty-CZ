...
instance PC_FIGHTER_LI(Npc_Default)
{
	name[0] = "Gorn";
	guild = GIL_DJG;
	id = 8054;
	...
	daily_routine = rtn_start_8054;
};


func void rtn_start_8054()
{
	TA_Cook_Campfire(6,0,17,0,"LI_MAN_04");
	TA_Sit_Campfire(17,0,6,0,"LI_MAN_04");
};

func void rtn_eatmeat_8054()
{
	TA_Stand_Eating(6,0,17,0,"LI_MAN_04");
	TA_Stand_Eating(17,0,6,0,"LI_MAN_04");
};

func void rtn_runaway_8054()
{
