...
instance Mil_350_Addon_Martin(Npc_Default)
{
	...
	B_SetNpcVisual(self,MALE,"Hum_Head_Thief",Face_P_OldMan_Gravo,BodyTex_P,ITAR_GRD_I);
...
{
	TA_Study_WP(4,0,21,0,"NW_CITY_PALCAMP_15");
	TA_WacheFackel(21,0,4,0,"NW_CITY_PALCAMP_15");
};

func void Rtn_Start_350()
{
	TA_Study_WP(4,0,23,0,"NW_CITY_PALCAMP_15");
	TA_Sit_Chair(23,0,4,0,"NW_CITY_HABOUR_TAVERN01_06");
};
