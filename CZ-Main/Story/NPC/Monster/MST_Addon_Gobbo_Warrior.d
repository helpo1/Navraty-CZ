...
{
	name[0] = CZ_NAME_Monster_GobboWarrior;
	guild = GIL_GOBBO;
...
{
	name[0] = CZ_NAME_Monster_GobboWarrior_Berserker;
	aivar[AIV_Gender] = TRUE;
	level = 17;
...
{
	name[0] = CZ_NAME_Monster_GobboWarrior_Grimgash;
	level = 35;
...
{
	name[0] = CZ_NAME_Monster_GobboWarrior_Berdysh;
	level = 20;
...
{
	name[0] = CZ_NAME_Monster_GRD_Gazkul;
	guild = GIL_DEMON;
	aivar[AIV_MM_REAL_ID] = ID_GOBBO_BLACK;
	level = 50;
