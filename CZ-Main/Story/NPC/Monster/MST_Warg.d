...
{
	name[0] = CZ_NAME_Monster_Warg_OrcHound;
	aivar[AIV_Gender] = TRUE;
	level = 15;
...
{
	name[0] = CZ_NAME_Monster_Warg_BlackWolf;
	aivar[AIV_Gender] = TRUE;
	level = 20;
...
{
	name[0] = CZ_NAME_Monster_Warg_Ghost;
	level = 50;
	guild = GIL_ORC;
...
{
	name[0] = CZ_NAME_Monster_Warg_Teneklyk;
	level = 45;
...
{
	name[0] = CZ_NAME_Monster_Warg_Tserebus;
	level = 50;
...
{
	name[0] = CZ_NAME_Monster_Warg_Summoned;
