...
{
	name[0] = CZ_NAME_Monster_Meatbug;
	guild = GIL_MEATBUG;
...
{
	name[0] = CZ_NAME_Monster_Meatbug_Crab;
	guild = GIL_MEATBUG;
...
{
	name = CZ_NAME_Monster_Riesennatter;
	guild	 = GIL_Meatbug;
