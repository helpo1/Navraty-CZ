...
{
	name[0] = CZ_NAME_Monster_Shadowbeast;
	guild = GIL_Gargoyle;
...
{
	name[0] = CZ_NAME_Monster_Shadowbeast_Bulmog;
	level = 50;
...
{
	name[0] = CZ_NAME_Monster_Shadowbeast_Muritan;
	level = 50;
	vars[1] = TRUE;
	aivar[AIV_Gender] = TRUE;
...
{
	name[0] = CZ_NAME_Monster_Shadowbeast_Ice;
	aivar[AIV_Gender] = TRUE;
	level = 90;
	attribute[ATR_STRENGTH] = 500;
	attribute[ATR_DEXTERITY] = 500;
...
{
	name[0] = CZ_NAME_Monster_Shadowbeast_Trakras_Title;
	level = 100;
	aivar[90] = TRUE;
...
{
	name[0] = CZ_NAME_Monster_Shadowbeast_FireSpirit;
	level = 50;
...
{
	name[0] = CZ_NAME_Monster_Shadowbeast_Ignaz;
	level = 1;
	guild = GIL_SHEEP;
	aivar[AIV_MM_REAL_ID] = ID_SHADOWBEAST;
	attribute[ATR_STRENGTH] = 250;
...
{
	name[0] = CZ_NAME_Monster_Shadowbeast_Krayt;
