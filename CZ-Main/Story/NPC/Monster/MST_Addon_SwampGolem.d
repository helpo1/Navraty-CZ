...
{
	name[0] = CZ_NAME_Monster_SwampGolem;
...
{
	name[0] = CZ_NAME_Monster_SwampGolem_Wood;
	level = 30;
...
{
	name[0] = CZ_NAME_Monster_SwampGolem_EarthElemental;
	level = 1;
	attribute[ATR_STRENGTH] = 200;
	attribute[ATR_DEXTERITY] = 100;
	attribute[ATR_HITPOINTS_MAX] = 1400;
...
{
	name[0] = CZ_NAME_Monster_SwampGolem_Summoned;
...
{
	name[0] = CZ_NAME_Monster_SwampGolem_Ekron_Title;
	level = 300;
	aivar[90] = TRUE;
	aivar[94] = NPC_EPIC;
