...
{
	name[0] = CZ_NAME_Monster_Troll_Young;
...
{
	name[0] = CZ_NAME_Monster_Troll_Utrog;
	aivar[AIV_Gender] = TRUE;
	aivar[94] = NPC_LEGEND;
	level = 100;
...
{
	name[0] = CZ_NAME_Monster_Troll_Uzdog;
	aivar[AIV_Gender] = TRUE;
	aivar[94] = NPC_LEGEND;
	level = 100;
	attribute[ATR_STRENGTH] = 600;
...
{
	name[0] = CZ_NAME_Monster_Troll_Ubrog;
	aivar[AIV_Gender] = TRUE;
	aivar[94] = NPC_LEGEND;
	level = 100;
	attribute[ATR_STRENGTH] = 600;
...
{
	name[0] = CZ_NAME_Monster_Troll_Cave;
	aivar[AIV_Gender] = TRUE;
	level = 60;
...
{
	name[0] = CZ_NAME_Monster_Troll_Utur;
	aivar[AIV_Gender] = TRUE;
	level = 100;
	aivar[90] = TRUE;
	aivar[94] = NPC_LEGEND;
...
{
	name[0] = CZ_NAME_Monster_Troll_Rock;
	aivar[AIV_Gender] = TRUE;
	level = 80;
	attribute[ATR_STRENGTH] = 600;
	attribute[ATR_DEXTERITY] = 200;
...
{
	name[0] = CZ_NAME_Monster_Troll_Enraged;
	aivar[AIV_Gender] = TRUE;
	guild = GIL_WOLF;
	level = 80;
	aivar[90] = TRUE;
