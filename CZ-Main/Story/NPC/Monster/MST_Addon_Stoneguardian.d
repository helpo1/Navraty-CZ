...
{
	name[0] = CZ_NAME_Monster_StoneGuardian;
...
{
	name[0] = CZ_NAME_Monster_StoneGuardian_Ancient;
	level = 15;
...
{
	name[0] = CZ_NAME_Monster_StoneGuardian_ForestSpirit;
...
{
	name[0] = CZ_NAME_Monster_StoneGuardian_TempleOfTears;
	level = 20;
	damagetype = DAM_BLUNT | DAM_FLY;
...
{
	name[0] = CZ_NAME_Monster_StoneGuardian_Summoned;
...
{
	name[0] = CZ_NAME_Monster_StoneGuardian_Titan;
	guild = GIL_Stoneguardian;
	level = 75;
	noFocus = TRUE;
...
{
	name[0] = CZ_NAME_Monster_StoneGuardian_Immortal;
	guild = GIL_Stoneguardian;
	level = 30;
	flags = NPC_FLAG_IMMORTAL;
...
{
	name[0] = CZ_NAME_Monster_StoneGuardian_Temple;
	guild = GIL_Stoneguardian;
	level = 45;
	damagetype = DAM_BLUNT;
	attribute[ATR_STRENGTH] = 400;
