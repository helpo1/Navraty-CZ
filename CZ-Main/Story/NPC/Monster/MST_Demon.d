...
{
	name[0] = CZ_NAME_Monster_Demon_SenyakServant;
	level = 1;
	attribute[ATR_STRENGTH] = 450;
	attribute[ATR_DEXTERITY] = 250;
	attribute[ATR_HITPOINTS_MAX] = 4000;
...
{
	name[0] = CZ_NAME_Monster_Demon_SummonedLow;
...
{
	name[0] = CZ_NAME_Monster_Demon_SummonedYoung;
	guild = GIL_SUMMONED_DEMON;
	aivar[AIV_MM_REAL_ID] = id_summoned_demon;
	level = 0;
...
{
	name[0] = CZ_NAME_Monster_Demon_SummonedOld;
	guild = GIL_SUMMONED_DEMON;
	aivar[AIV_MM_REAL_ID] = id_summoned_demon;
	level = 0;
...
{
	name[0] = CZ_NAME_Monster_Demon_SummonedHigh;
	guild = GIL_SUMMONED_DEMON;
	aivar[AIV_MM_REAL_ID] = id_summoned_demon;
	level = 0;
...
{
	name[0] = CZ_NAME_Monster_Demon_Keyron;
	level = 75;
...
{
	name[0] = CZ_NAME_Monster_Demon_Teamruk;
	level = 100;
	aivar[90] = TRUE;
	aivar[94] = NPC_LEGEND;
