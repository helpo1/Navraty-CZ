...
{
	name[0] = CZ_NAME_Monster_Minecrawler;
...
{
	name[0] = CZ_NAME_Monster_Minecrawler_Hatched;
	aivar[AIV_Gender] = TRUE;
	level = 0;
...
{
	name[0] = CZ_NAME_Monster_Minecrawler_Poison;
	level = 35;
...
{
	name[0] = CZ_NAME_Monster_Minecrawler_Spider;
	guild = GIL_BLOODFLY;
	vars[1] = TRUE;
...
{
	name[0] = CZ_NAME_Monster_Minecrawler_GiantSpider;
	guild = GIL_BLOODFLY;
	vars[1] = TRUE;
	aivar[AIV_MM_REAL_ID] = ID_SPIDER;
	level = 10;
...
{
	name[0] = CZ_NAME_Monster_Minecrawler_MountainSpider;
	guild = GIL_BLOODFLY;
	vars[1] = TRUE;
	aivar[AIV_MM_REAL_ID] = ID_SPIDER;
	level = 25;
...
{
	name[0] = CZ_NAME_Monster_Minecrawler_Agelidas;
	guild = GIL_BLOODFLY;
	vars[1] = TRUE;
	aivar[AIV_MM_REAL_ID] = ID_SPIDER;
	level = 60;
...
{
	name[0] = CZ_NAME_Monster_Minecrawler_Garantula;
	guild = GIL_BLOODFLY;
	vars[1] = TRUE;
	aivar[AIV_MM_REAL_ID] = ID_SPIDER;
	level = 80;
...
{
	name[0] = CZ_NAME_Monster_Minecrawler_Shivana;
	guild = GIL_BLOODFLY;
	vars[1] = TRUE;
	aivar[AIV_MM_REAL_ID] = ID_SPIDER;
	level = 80;
...
{
	name[0] = CZ_NAME_Monster_Minecrawler_Shaliya;
	guild = GIL_BLOODFLY;
	vars[1] = TRUE;
	aivar[AIV_MM_REAL_ID] = ID_SPIDER;
	level = 100;
...
{
	name[0] = CZ_NAME_Monster_Minecrawler_Kuta;
	guild = GIL_BLOODFLY;
	vars[1] = TRUE;
	aivar[AIV_MM_REAL_ID] = ID_SPIDER;
	level = 120;
...
{
	name[0] = CZ_NAME_Monster_Minecrawler_Tararantul;
	guild = GIL_BLOODFLY;
	vars[1] = TRUE;
	aivar[AIV_MM_REAL_ID] = ID_SPIDER;
	level = 150;
