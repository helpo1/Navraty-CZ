...
{
	name[0] = CZ_NAME_Monster_IceGolem;
	guild = GIL_ICEGOLEM;
...
{
	name[0] = CZ_NAME_Monster_IceGolem_IceElemental;
	level = 1;
...
{
	name[0] = CZ_NAME_Monster_IceGolem_Summoned;
...
{
	name[0] = CZ_NAME_Monster_IceGolem_Oktogor;
	level = 75;
