...
{
	name[0] = CZ_NAME_Monster_SkeletonMage;
	guild = GIL_SKELETON;
...
{
	name[0] = CZ_NAME_Monster_SkeletonMage_SummonedGuard;
...
{
	name[0] = CZ_NAME_Monster_SkeletonMage_Ghost;
	level = 50;
...
{
	name[0] = CZ_NAME_Monster_SkeletonMage_AncientGhost;
	level = 100;
	aivar[94] = NPC_LEGEND;
	aivar[AIV_MM_REAL_ID] = ID_GHOST;
...
{
	name[0] = CZ_NAME_Monster_SkeletonMage_GhostMinion;
	level = 1;
	aivar[AIV_MM_REAL_ID] = ID_GHOST;
	attribute[ATR_STRENGTH] = 300;
	attribute[ATR_DEXTERITY] = 1000;
...
{
	name[0] = CZ_NAME_Monster_SkeletonMage_Izulg_Title;
	level = 150;
	guild = GIL_SKELETON;
	aivar[90] = TRUE;
	aivar[94] = NPC_EPIC;
...
{
	name[0] = CZ_NAME_Monster_SkeletonMage_Asinoks_Title;
	level = 150;
	guild = GIL_SKELETON;
	aivar[90] = TRUE;
	aivar[94] = NPC_EPIC;
