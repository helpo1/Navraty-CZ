...
{
	name[0] = CZ_NAME_Monster_Zombie_AlefSoul;
	guild = GIL_ZOMBIE;
	aivar[AIV_MM_REAL_ID] = ID_ZOMBIE;
	level = 30;
...
{
	name[0] = CZ_NAME_Monster_Zombie_Riordian;
	guild = GIL_ZOMBIE;
	aivar[AIV_MM_REAL_ID] = ID_ZOMBIE;
	level = 30;
	flags = 0;
...
{
	name[0] = CZ_NAME_Monster_Zombie_Novice;
	level = 10;
	attribute[ATR_STRENGTH] = 300;
	attribute[ATR_DEXTERITY] = 75;
	attribute[ATR_HITPOINTS_MAX] = 400;
...
{
	name[0] = CZ_NAME_Monster_Zombie_PlagueNovice;
	level = 15;
	vars[1] = TRUE;
...
{
	name[0] = CZ_NAME_Monster_Zombie_Plague;
	vars[1] = TRUE;
	level = 17;
	attribute[ATR_STRENGTH] = 250;
	attribute[ATR_DEXTERITY] = 75;
...
{
	name[0] = CZ_NAME_Monster_Zombie_Gomez;
	level = 20;
	attribute[ATR_STRENGTH] = 300;
	attribute[ATR_DEXTERITY] = 75;
	attribute[ATR_HITPOINTS_MAX] = 1000;
...
{
	name[0] = CZ_NAME_Monster_Zombie_Paladin;
	level = 22;
...
{
	name[0] = CZ_NAME_Monster_Zombie_Warrior;
	level = 18;
...
{
	name[0] = CZ_NAME_Monster_Zombie_Summoned;
...
{
	name[0] = CZ_NAME_Monster_Zombie_GomezWorkerSoul;
	guild = GIL_ZOMBIE;
...
{
	name[0] = CZ_NAME_Monster_Zombie_Miragul;
	guild = GIL_ZOMBIE;
	aivar[AIV_MM_REAL_ID] = ID_ZOMBIE;
	level = 150;
	aivar[90] = TRUE;
...
{
	name[0] = CZ_NAME_Monster_Zombie_Nergal;
	guild = GIL_ZOMBIE;
	aivar[AIV_MM_REAL_ID] = ID_ZOMBIE;
	level = 60;
	aivar[90] = TRUE;
...
{
	name[0] = CZ_NAME_Monster_Zombie_Mummy;
	level = 25;
...
{
	name[0] = CZ_NAME_Monster_Zombie_Niorret;
	level = 200;
	aivar[90] = TRUE;
	aivar[94] = NPC_EPIC;
	attribute[ATR_STRENGTH] = 500;
...
{
	name[0] = CZ_NAME_Monster_Zombie_DarkReaper;
	level = 150;
	aivar[90] = TRUE;
	aivar[94] = NPC_EPIC;
	damagetype = DAM_EDGE;
...
{
	name[0] = CZ_NAME_Monster_SkeletonLord_Malbar;
	guild = GIL_SKELETON;
	id = 3010;
	flags = 0;
	aivar[90] = TRUE;
...
{
	name[0] = CZ_NAME_Monster_Zombie_Soul;
	level = 1;
	aivar[AIV_EnemyOverride] = TRUE;
	flags = NPC_FLAG_GHOST | NPC_FLAG_IMMORTAL;
...
{
	name[0] = CZ_NAME_Monster_Zombie_AraharPlague;
	level = 200;
	aivar[90] = TRUE;
	aivar[94] = NPC_EPIC;
...
{
	name[0] = CZ_NAME_Monster_Zombie_Ancient;
	level = 40;
	aivar[94] = NPC_LEGEND;
	attribute[ATR_STRENGTH] = 500;
	attribute[ATR_DEXTERITY] = 75;
