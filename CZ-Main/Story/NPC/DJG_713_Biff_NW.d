...
instance DJG_713_Biff_NW(Npc_Default)
{
	...
	B_SetNpcVisual(self,MALE,"Hum_Head_Bald",Face_N_Normal16,BodyTex_N,itar_djg_m_NPC);
...
func void rtn_tot_7130()
{
	TA_Stand_WP(8,0,20,0,"TOT");
	TA_Stand_WP(20,0,8,0,"TOT");
};

func void rtn_orcatcnw_7130()
{
	TA_Stand_ArmsCrossed(8,0,23,0,"NW_BIGFARM_PATH_BIFF_01");
	TA_Stand_ArmsCrossed(23,0,8,0,"NW_BIGFARM_PATH_BIFF_01");
};

func void rtn_shipnew_7130()
{
	TA_Stand_Guarding(8,0,22,0,"SHIP_DECK_10");
	TA_Stand_Guarding(22,0,8,0,"SHIP_DECK_10");
};

func void rtn_killhim_7130()
{
	TA_Stand_WP(8,0,20,0,"NW_CITY_MERCHANT_PATH_22_B");
	TA_Stand_WP(20,0,8,0,"NW_CITY_MERCHANT_PATH_22_B");
};
