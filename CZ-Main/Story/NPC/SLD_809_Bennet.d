...
instance SLD_809_Bennet(Npc_Default)
{
	...
	B_SetNpcVisual(self,MALE,"Hum_Head_FatBald",Face_N_CoolPock,BodyTex_N,ITAR_HeavySmith);
...
func void rtn_tot_809()
{
	TA_Stand_WP(8,0,20,0,"TOT");
	TA_Stand_WP(20,0,8,0,"TOT");
};

func void rtn_shipnew_809()
{
	TA_Stand_Guarding(8,0,22,0,"SHIP_DECK_13");
	TA_Stand_Guarding(22,0,8,0,"SHIP_DECK_13");
};

func void rtn_capturethrbattle_809()
{
	TA_Stand_WP(8,0,20,0,"NW_CITY_HABOUR_KASERN_MELHIOR");
	TA_Stand_WP(20,0,8,0,"NW_CITY_HABOUR_KASERN_MELHIOR");
};
