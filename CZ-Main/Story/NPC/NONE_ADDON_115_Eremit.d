...
func void Rtn_Start_115()
{
	...
	TA_Cook_Campfire(9,0,11,0,"ADW_VALLEY_BENCH");
	TA_Stand_Eating(11,0,13,0,"ADW_VALLEY_BENCH");
	TA_Sit_Bench(13,0,15,0,"ADW_VALLEY_BENCH");
	TA_Cook_Campfire(15,0,17,0,"ADW_VALLEY_BENCH");
	TA_Stand_Eating(17,0,19,0,"ADW_VALLEY_BENCH");
	TA_Sit_Bench(19,0,1,0,"ADW_VALLEY_BENCH");
	TA_Sleep(1,0,7,0,"ADW_VALLEY_PATH_031_HUT");
};

func void Rtn_WaterMage_115()
{
	TA_Stand_ArmsCrossed(8,0,23,0,"ADW_ENTRANCE_PLATEAU_12");
	TA_Stand_ArmsCrossed(23,0,8,0,"ADW_ENTRANCE_BUILDING2_02");
};

func void rtn_orcinvasion_115()
{
	TA_Stand_Guarding(8,25,21,35,"ADW_PORTALTEMPEL_03");
	TA_Stand_Guarding(21,35,8,25,"ADW_PORTALTEMPEL_03");
};