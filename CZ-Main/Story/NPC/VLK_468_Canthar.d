...
func void Rtn_PreStart_468()
{
	...
	TA_Sit_Throne(23,0,8,0,"NW_FARM1_INHOUSE_03_SIT");
};

func void Rtn_Start_468()
{
	TA_Sit_Bench(7,45,19,45,"NW_CITY_MERCHANT_PATH_30");
	TA_Sleep(19,45,7,45,"NW_CITY_HOTEL_BED_01");
};

func void Rtn_Marktstand_468()
{
	TA_Stand_TraderCity(7,45,19,45,"NW_CITY_SARAH");
	TA_Sit_Bench(19,45,0,45,"NW_CITY_CANTAR_KILL");
...
func void Rtn_CanKill_468()
{
	TA_Stand_ArmsCrossed(7,45,19,45,"NW_CITY_MERCHANT_PATH_36");
	TA_Sit_Bench(19,45,0,45,"NW_CITY_CANTAR_KILL");
	TA_Sleep(0,45,7,45,"NW_CITY_HOTEL_BED_01");
};