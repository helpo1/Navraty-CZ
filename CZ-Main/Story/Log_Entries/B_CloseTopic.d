...
func void B_CloseTopic(var string topic,var int MissionVar,var int CommonVar,var int EndChapter)
{
	...
	{
		Log_SetTopicStatus(topic,LOG_CLOSED);
	}
...
func void B_CloseTopic_Failed(var string topic,var int MissionVar,var int CommonVar,var int EndChapter)
{
	if(MissionVar == LOG_FAILED)
	{
		Log_SetTopicStatus(topic,LOG_OBSOLETE);
	};
};