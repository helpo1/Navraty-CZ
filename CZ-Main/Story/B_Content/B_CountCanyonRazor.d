...
func void B_CountCanyonRazor()
{
	...
	if(CanyonRazorBodyCount == 0)
	{
		AI_Print("Všechny břitvy zlikvidovány!");
	}
	else
	{
		PRINTRAZORCOUNT = TRUE;
		CanyonRazorText = ConcatStrings("Zbývá ",b_formnumberstring(10 - CanyonRazorBodyCount));
		PRINTRAZORCOUNT = FALSE;
		AI_Print(CanyonRazorText);
	};
};
