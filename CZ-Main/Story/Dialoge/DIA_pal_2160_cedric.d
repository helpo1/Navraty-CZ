...
instance DIA_PAL_2160_CEDRIC_TEACH(C_Info)
{
	...
	permanent = TRUE;
	description = "Jsem připraven k tréninku.";
};
...
{
	AI_Output(other,self,"DIA_Cedric_Teach_15_00");	//Jsem připraven k tréninku.
	if(other.HitChance[NPC_TALENT_1H] >= 90)
	{
		AI_Output(self,other,"DIA_Cedric_Teach_12_01");	//O boji s mečem již víš úplně vše, není nic co bych tě mohl naučit.
