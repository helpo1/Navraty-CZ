...
func void dia_harum_hello_info()
{
	...
	AI_Output(self,other,"DIA_Harum_Hello_01_03");	//Ty jsi pravděpodobně poutník osudu, který přišel do naší země. Dugo mi o tobě řekl.
	AI_Output(self,other,"DIA_Harum_Hello_01_04");	//Všichni o tobě mluví. Pro mnohé jsi světlo, které nás vyvede z temnoty.
	AI_Output(self,other,"DIA_Harum_Hello_01_13");	//Ale můžu říci, že i jiní čekali na tvůj příchod...
	AI_Output(self,other,"DIA_Harum_Hello_01_14");	//... Mluví se o tobě v faliantě Humgata.
	...
	AI_Output(self,other,"DIA_Harum_Hello_01_21");	//O těch časech a lidech, kteří zde žili toho mnoho nevíme. Tyto znalosti byly ztraceny navždy.
	...
	AI_Output(self,other,"DIA_Harum_Hello_01_26");	//V jedné části Kalimdoru byla skryta legenda.
	...
	AI_Output(self,other,"DIA_Harum_Hello_01_32");	//... Povstane Velký Stín, aby ustanovil svou říši...
	...
	AI_Output(self,other,"DIA_Harum_Hello_01_38");	//Ale kromě legendy je tu další zajímavá věc.
	...
	AI_Output(self,other,"DIA_Harum_Hello_01_42");	//... Se zjeví Obránce, aby jednal proti temnotě...
	AI_Output(self,other,"DIA_Harum_Hello_01_43");	//... Povede přežívší proti zlu a zničí Velký Stín...
	AI_Output(self,other,"DIA_Harum_Hello_01_44");	//... Dostane jméno Poutník Osudu...
	AI_Output(self,other,"DIA_Harum_Hello_01_45");	//No, to ještě úplně neznamená, že jsi ten z legendy.
	...
	AI_Output(self,other,"DIA_Harum_Hello_01_51");	//(v hrůze) Azgalor?! Legendy o tomto stvoření leží daleko v dětství tohoto světa.
	AI_Output(self,other,"DIA_Harum_Hello_01_52");	//V knize Kalimdoru je podobné stvoření zmíněno.
	AI_Output(self,other,"DIA_Harum_Hello_01_53");	//Ale nikdo ho zde nikdy neviděl. Ale spíše je pravděpodobné, že nikdo nepřežil setkání s ním.
	AI_Output(self,other,"DIA_Harum_Hello_01_54");	//Ale nemůžu ti přesně povědět, jestli je to opravdu jenom mýtus.
	if(MIS_URNAZULRAGE == LOG_Running)
	{
		B_LogEntry(TOPIC_URNAZULRAGE,"Elvais mi řekl o mocném artefaktu známem jako Oko hněvu. Pravděpodobně nějak souvisí s návratem Azgalora do údolí.");
	};
	MEETHARUM = TRUE;
};
...
func void dia_harum_hello_two_info()
{
	...
	AI_Output(self,other,"DIA_Harum_Hello_Two_01_02");	//Jak to můžeš vědět?!... (udiveně)
	AI_Output(other,self,"DIA_Harum_Hello_Two_01_03");	//Potkal jsem se s někým, kdo tvrdí, že ho viděl.
	...
	AI_Output(self,other,"DIA_Harum_Hello_Two_01_08");	//A já vím, nejsou to zrovna přátelská stvoření - nemyslím, že by mluvili s člověkem.
	...
	AI_Output(other,self,"DIA_Harum_Hello_Two_01_12");	//Portál, kterým jsem se zde dostal, stojí v podzemním městě skřetů.
	AI_Output(self,other,"DIA_Harum_Hello_Two_01_13");	//Jo, Dugo mi něco říkal.
	...
	AI_Output(other,self,"DIA_Harum_Hello_Two_01_32");	//Takže Kalimdor byl navždy...
	AI_Output(self,other,"DIA_Harum_Hello_Two_01_33");	//Prokletí skřeti! Bez nich by svět byl lepší... (agresivně)
	AI_Output(other,self,"DIA_Harum_Hello_Two_01_34");	//Byli pouze nástrojem, nemohli za to.
	AI_Output(other,self,"DIA_Harum_Hello_Two_01_35");	//Ale pak padlo prokletí na všechny obyvatelé údolí...
	...
	AI_Output(other,self,"DIA_Harum_Hello_Two_01_45");	//Skřeti bojovali zuřivě a dovedně, ale nepřátel bylo příliš mnoho.
	...
	AI_Output(self,other,"DIA_Harum_Hello_Two_01_52");	//Tak to opravdu bylo?!... Skřeti mě někdy překvapují!
	...
	B_LogEntry(TOPIC_HUMANINVALLEY,"Řekl jsem Elvaisovi vše, co mi řekl Ur-Thrall. Napadlo mě jak pomoci těmto lidem z údolí. Jestli zabiju Azgalora, Ur-Thrall by mohl nechat lidi projít skřetím městem do Khorinisu.");
	MEETHARUMONE = TRUE;
};
...
func void dia_harum_hello_three_info()
{
	...
	B_LogEntry(TOPIC_URNAZULRAGE,"Elvais zmínil jednu kryptu, ve které má být knihovna. Možná tam najdu své odpovědi, ale jsou tam nemrtví.");
	MEETHARUMTWO = TRUE;
};
...
func void dia_harum_hello_four_info()
{
	...
	AI_Output(self,other,"DIA_Harum_Hello_Four_01_04");	//Měl bys odpovědi hledat mimo tuto jeskyni.
...
instance DIA_HARUM_HELLO_FIVE(C_Info)
{
	...
	permanent = TRUE;
	important = FALSE;
	description = "Říkal jsi, že jsi zde někde viděl skřety.";
};
...
{
	AI_Output(other,self,"DIA_Harum_Hello_Five_01_01");	//Říkal jsi, že jsi zde někde viděl skřety.
...
func void dia_harum_hello_six_info()
{
	...
	AI_Output(self,other,"DIA_Harum_Hello_Six_01_05");	//Věděl jsem... Věděl jsem, že ty jsi TEN muž z legendy.
	...
	AI_Output(self,other,"DIA_Harum_Hello_Six_01_11");	//Myslím, že ostatní nebudou proti!
	...
	if(MEETURGROM > 0)
	{
		...
		AI_Output(self,other,"DIA_Harum_Hello_Six_01_19");	//Trochu jsi mě zaskočil... Ale... (tajemně)
		AI_Output(self,other,"DIA_Harum_Hello_Six_01_23");	//Hodně štěstí!
		B_LogEntry(TOPIC_HUMANINVALLEY,"Elvais a ostatní nechtěli opustit údolí. Ale já myslím, že by měli. Po pádu kletby se zase začne hemžit skřety. Mel bych promluvit s Ur-Gromem, koneckonců, nyní je vůdcem on.");
	}
	else
	{
...
{
	B_GivePlayerXP(300);
	AI_Output(other,self,"DIA_Harum_Hello_Seven_01_01");	//Skřeti tě nechají projít! Dohodl jsem se s jejich vůdcem, můžete odejít.
	AI_Output(self,other,"DIA_Harum_Hello_Seven_01_02");	//Udělal jsi pro nás hodně, cizinče, ale nemáme ti jak poděkovat.
...
func void dia_harum_seekazgolor_info()
{
	...
	B_LogEntry(TOPIC_URNAZULRAGE,"Elvais nebyl schopen přeložit knihu, kterou jsem v ruinách našel, ale dokázal identifikovat skřetí jazyk. Měl bych se podívat po nějakém skřetovi.");
	SEEKAZGOLOR = FALSE;
};
