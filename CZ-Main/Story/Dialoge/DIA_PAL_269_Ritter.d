...
{
	AI_Output(self,other,"DIA_Ritter_HERO_04_00");	//Tvá přítomnost zde nás těší. Budeme z ní čerpat svou odvahu.
	if(DIA_Ritter_HERO_NoPerm == FALSE)
	{
		AI_Output(self,other,"DIA_Ritter_HERO_04_01");	//Víme, že ve městě na nás stále myslí. Innosovým okem jsme střeženi v tuto hodinu.
		AI_Output(self,other,"DIA_Ritter_HERO_04_02");	//Jestli draci znovu napadnou hrad, zničí bránu úplně a skřeti se sem dostanou. Zemřeme jako Innosovi služebníci.
