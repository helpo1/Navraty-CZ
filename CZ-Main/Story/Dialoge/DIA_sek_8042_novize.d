...
func void dia_sek_8042_novize_noforever_info()
{
	...
	{
		AI_Output(self,other,"DIA_SEK_8042_Novize_NoForever_01_00");	//Nevyrušuj mě od práce!
		AI_StopProcessInfos(self);
	}
	else
	{
		AI_Output(self,other,"DIA_SEK_8042_Novize_NoForever_01_01");	//Jdi pryč! Nech mě odpočinout...
		AI_StopProcessInfos(self);
	};
};
