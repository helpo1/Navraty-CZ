...
func void DIA_Addon_Tonak_NW_Hi_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_Tonak_NW_Hi_03_01");	//Hej, můj zachránče! Ano, teď jsem zpátky, abych si upracoval prsty až na kost.

	if(!Npc_IsDead(Egill) && !Npc_IsDead(Ehnim))
	{
		AI_Output(self,other,"DIA_Addon_Tonak_NW_Hi_03_02");	//Hlavně s těmihle bratry. Chlape, bylo to opravdu tak špatné u TĚCH banditů...
	};
};
