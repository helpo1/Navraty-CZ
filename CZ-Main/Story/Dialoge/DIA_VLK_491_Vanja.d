...
instance DIA_Vanja_DOPE(C_Info)
{
	...
	permanent = FALSE;
	description = "Kde bych mohl koupit nějakou trávu?";
};
...
{
	AI_Output(other,self,"DIA_Vanja_DOPE_15_00");	//Kde bych mohl koupit nějakou trávu?
	AI_Output(self,other,"DIA_Vanja_DOPE_17_01");	//Nemám tušení. Radši od toho dej ruce pryč.
	AI_Output(self,other,"DIA_Vanja_DOPE_17_02");	//Protože jestli se na to nepřestaneš ptát, mohl bys z toho mít velký problém...
};
