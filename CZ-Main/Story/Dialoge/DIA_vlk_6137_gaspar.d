...
func void dia_vlk_6137_gaspar_hello_info()
{
	...
	AI_Output(self,other,"DIA_VLK_6137_Gaspar_Hello_01_12");	//Pokud tě zajímají podrobnosti toho případu, tak by si si měl pohovořit se samotným lordem Andrem.
...
func void dia_vlk_6137_gaspar_inprisoinab_info()
{
	...
	if((Npc_HasItems(other,itri_hakonmissring) >= 1) && (JOTELLSGASPAR == TRUE))
	{
		...
		AI_Output(other,self,"DIA_VLK_6137_Gaspar_InPrisoinAb_01_10");	//A ví toho o tobě tolik, že to bude stačit, aby si šel bručet.
