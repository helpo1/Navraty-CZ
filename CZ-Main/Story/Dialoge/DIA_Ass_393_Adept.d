...
func void DIA_Ass_393_Adept_hello_info()
{
	...
	AI_Output(self,other,"DIA_Ass_393_Adept_hello_01_02");	//Zajímavé. Co by si chtěl po Nazimovi?
	AI_Output(other,self,"DIA_Ass_393_Adept_hello_01_03");	//Nechtěl by si pracovat pro mistra Osaira?
...
func void DIA_Ass_393_Adept_GetOutCave_info()
{
	...
	if(NazimPissOff == TRUE)
	{
		...
		AI_Output(self,other,"DIA_Ass_393_Adept_GetOutCave_01_04");	//Takže už by bylo lepší, kdyby si mi nechodil na oči.
	...
	else if(NazimGetOutCave == TRUE)
	{
		...
		AI_Output(other,self,"DIA_Ass_393_Adept_GetOutCave_01_13");	//Ano, je to pravda. A pokud se už nechceš vrátit sem zpatky, měl by si přijmout moji nabidku.
