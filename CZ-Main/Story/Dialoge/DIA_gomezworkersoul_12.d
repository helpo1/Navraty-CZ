...
func void dia_gomezworkersoul_12_hallo_info()
{
	...
	AI_Output(other,self,"DIA_GomezWorkerSoul_12_HALLO_01_02");	//Výměnou za tuhle službu ti pomůžu zbavit tvou duši prokletí. Chceš to?
	AI_Output(self,other,"DIA_GomezWorkerSoul_12_HALLO_01_03");	//Jsi vynalézavý, člověče... (mrtvým hlasem) Jsem tedy ochotný dát všechno to málo, co ve mně ostalo.
	AI_Output(other,self,"DIA_GomezWorkerSoul_12_HALLO_01_04");	//Od tebe není nic podstatného pro mě, kromě odpuštění pro jednu prokletou duši, stejně jako jsi ty!
	AI_Output(self,other,"DIA_GomezWorkerSoul_12_HALLO_01_05");	//Která duša potřebuje mé odpuštění?... (mrtvým hlasem)
...
func void dia_gomezworkersoul_12_hallo_end()
{
	...
	AI_Output(self,other,"DIA_GomezWorkerSoul_12_HALLO_End_01_02");	//Ano!... (mrtvým hlasem) Má ode mě odpuštění.
	AI_Output(other,self,"DIA_GomezWorkerSoul_12_HALLO_End_01_03");	//Tohle všechno pro mě bylo od tebe nezbytné. Jsi připraven jít na věčný odpočinek, duchu?
	AI_Output(self,other,"DIA_GomezWorkerSoul_12_HALLO_End_01_04");	//Ano, jsem připraven! Aargh!... (mrtvým hlasem)
