...
{
	AI_Output(other,self,"DIA_Addon_Wache_01_Hi_15_00");	//Vše v pohodě?
	AI_Output(self,other,"DIA_Addon_Wache_01_Hi_04_01");	//Dotkni se Estebana a já tě rozsekám na kousky.
	AI_StopProcessInfos(self);
};
