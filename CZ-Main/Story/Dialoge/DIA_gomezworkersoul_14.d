...
func void dia_gomezworkersoul_14_hallo_info()
{
	...
	AI_Output(other,self,"DIA_GomezWorkerSoul_14_HALLO_01_07");	//Ale ještě předtím, než ti pomůžu, měl bys pomoct i ty mně s jednou choulostivou záležitostí.
	...
	AI_Output(self,other,"DIA_GomezWorkerSoul_14_HALLO_01_10");	//Které duši bych měl odpustit?... (mrtvým hlasem)
...
func void dia_gomezworkersoul_14_hallo_end()
{
	...
	AI_Output(other,self,"DIA_GomezWorkerSoul_14_HALLO_End_01_01");	//Souhlasíš s těmito podmínkami?!
	AI_Output(self,other,"DIA_GomezWorkerSoul_14_HALLO_End_01_02");	//Ano, souhlasím!... (mrtvým hlasem) Dostane mé odpuštění výměnou za mé očistění.
