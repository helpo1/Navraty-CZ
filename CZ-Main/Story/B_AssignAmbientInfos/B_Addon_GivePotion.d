...
{
	AI_Output(other,self,"DIA_Addon_GoWithMe_01_00");	//Do útoku!
	AI_Output(self,other,"DIA_Addon_GoWithMe_01_01");	//Dobře, že to říkáš!
...
instance DIA_Addon_Steal(C_Info)
{
	...
	permanent = TRUE;
	description = "(pokusit se ukrást měšec)";
};
