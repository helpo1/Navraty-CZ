...
func void B_AddCityGuideChoices()
{
	...
	{
		Info_AddChoice(dia_cityguide,"Do dolní čtvrti.",dia_cityguide_unterstadt);
	};
...
{
	AI_Output(other,self,"DIA_CITYGUIDE_UNTERSTADT_15_00");	//Jak se dostanu do dolní čtvrti?
...
{
	AI_Output(other,self,"DIA_CITYGUIDE_OBERSTADT_15_00");	//Kudy do horní čtvrti?
	if(C_NpcIsInQuarter(self) == Q_UNTERSTADT)
	{
...
{
	AI_Output(other,self,"DIA_CITYGUIDE_TEMPEL_15_00");	//Hledám chrámové náměstí.
	if(C_NpcIsInQuarter(self) == Q_UNTERSTADT)
	{
...
{
	AI_Output(other,self,"DIA_CITYGUIDE_HAFEN_15_00");	//Kde je přístavní čtvrř?
	if(C_NpcIsInQuarter(self) == Q_UNTERSTADT)
	{
