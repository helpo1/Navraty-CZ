...
func void b_assignfortwatchguard(var C_Npc watchguardfort)
{
	if(GRANTTOFORT == TRUE)
	{
		...
		{
			AI_Output(self,other,"DIA_Pal_Schiffswache_Ambient_04_00");	//Sledujeme tě.
		};
		if(watchguardfort.voice == 9)
		{
			AI_Output(self,other,"DIA_Pal_Schiffswache_Ambient_09_01");	//Dokud si tady, nedostaň se do problémů.
		};
		if(watchguardfort.voice == 12)
		{
			AI_Output(self,other,"DIA_Pal_Schiffswache_Ambient_12_02");	//Ani nemysli na to, tady cokoli ukrást. Rozumíš?
		};
