...
{
	name[0] = CZ_NAME_Monster_Skeleton_Fighter;
	guild = GIL_SKELETON;
...
{
	name[0] = CZ_NAME_Monster_Skeleton_Digger;
	guild = GIL_SKELETON;
	level = 10;
...
{
	name[0] = CZ_NAME_Monster_Skeleton_Aleph;
	guild = GIL_SKELETON;
	level = 10;
	aivar[AIV_MM_REAL_ID] = ID_ZOMBIE_OM;
	attribute[ATR_STRENGTH] = 180;
...
{
	name[0] = CZ_NAME_Monster_Skeleton_JustSkeleton;
	level = 10;
	attribute[ATR_STRENGTH] = 180;
	attribute[ATR_DEXTERITY] = 80;
	attribute[ATR_HITPOINTS_MAX] = 300;
...
{
	name[0] = CZ_NAME_Monster_Skeleton_DarkJustSkeleton;
	level = 12;
...
{
	name[0] = CZ_NAME_Monster_Skeleton_Spear;
	level = 15;
	attribute[ATR_STRENGTH] = 270;
	attribute[ATR_DEXTERITY] = 150;
...
{
	name[0] = CZ_NAME_Monster_Skeleton_Guard;
	level = 20;
	attribute[ATR_STRENGTH] = 270;
	attribute[ATR_DEXTERITY] = 150;
...
{
	name[0] = CZ_NAME_Monster_Skeleton_DarkFighter;
	guild = GIL_SKELETON;
	aivar[AIV_MM_REAL_ID] = ID_SKELETON;
	level = 17;
	attribute[ATR_STRENGTH] = 350;
...
{
	name[0] = CZ_NAME_Monster_Skeleton_ServantEvil;
	level = 15;
	attribute[ATR_STRENGTH] = 350;
	attribute[ATR_DEXTERITY] = 250;
...
{
	name[0] = CZ_NAME_Monster_Skeleton_XardasGuard;
	guild = GIL_KDM;
...
{
	name[0] = CZ_NAME_Monster_Skeleton_Warrior;
	level = 20;
	attribute[ATR_STRENGTH] = 350;
	attribute[ATR_DEXTERITY] = 250;
	attribute[ATR_HITPOINTS_MAX] = 1200;
...
{
	name[0] = CZ_NAME_Monster_Skeleton_DarkWarrior;
	level = 50;
...
{
	name[0] = CZ_NAME_Monster_Skeleton_DarkBerserker;
	level = 40;
...
{
	name[0] = CZ_NAME_Monster_Skeleton_DarkSpear;
	level = 50;
	attribute[ATR_STRENGTH] = 500;
	attribute[ATR_DEXTERITY] = 250;
...
{
	name[0] = CZ_NAME_Monster_Skeleton_DarkGuard;
	level = 45;
	attribute[ATR_STRENGTH] = 400;
	attribute[ATR_DEXTERITY] = 250;
	attribute[ATR_HITPOINTS_MAX] = 4500;
...
{
	name[0] = CZ_NAME_Monster_Skeleton_DarkCommander;
	level = 75;
...
{
	name[0] = CZ_NAME_Monster_Skeleton_KreolGuard;
	guild = GIL_SKELETON;
	level = 60;
...
{
	name[0] = CZ_NAME_Monster_Skeleton_SoulGuard;
	level = 1;
...
{
	name[0] = CZ_NAME_Monster_Skeleton_DagKar;
	level = 100;
...
{
	name[0] = CZ_NAME_Monster_Skeleton_ValZar;
	level = 100;
...
{
	name[0] = CZ_NAME_Monster_Skeleton_TraKor;
	level = 100;
	attribute[ATR_STRENGTH] = 820;
	attribute[ATR_DEXTERITY] = 250;
	attribute[ATR_HITPOINTS_MAX] = 20000;
...
{
	name[0] = CZ_NAME_Monster_Skeleton_ItuSed;
	level = 100;
...
{
	name[0] = CZ_NAME_Monster_Skeleton_Summoned;
...
{
	name[0] = CZ_NAME_Monster_Skeleton_SummonedWarrior;
	guild = GIL_SUMMONED_SKELETON;
	aivar[AIV_MM_REAL_ID] = ID_SUMMONED_SKELETON;
	level = 0;
...
{
	name[0] = CZ_NAME_Monster_Skeleton_SummonedGuard;
	guild = GIL_SUMMONED_SKELETON;
	aivar[AIV_MM_REAL_ID] = ID_SUMMONED_SKELETON;
	level = 0;
	attribute[ATR_STRENGTH] = 400;
...
{
	name[0] = CZ_NAME_Monster_Skeleton_Orc_V1;
	guild = GIL_SUMMONED_SKELETON;
	aivar[AIV_MM_REAL_ID] = ID_SUMMONED_SKELETON;
	level = 0;
	attribute[ATR_STRENGTH] = 300;
...
{
	name[0] = CZ_NAME_Monster_Skeleton_CryptGuard;
	B_SetVisuals_Skeleton();
	EquipItem(self,ITMW_1H_DOOMSWORD);
...
{
	name[0] = CZ_NAME_Monster_Skeleton_AncientBuildersWarrior;
	level = 40;
	aivar[AIV_MM_REAL_ID] = ID_ZOMBIE_OM;
	attribute[ATR_STRENGTH] = 500;
	attribute[ATR_DEXTERITY] = 350;
...
{
	name[0] = CZ_NAME_Monster_Skeleton_ZombieGuard;
	level = 20;
...
{
	name[0] = CZ_NAME_Monster_Skeleton_FireSpirit;
	level = 40;
...
{
	name[0] = CZ_NAME_Monster_Skeleton_Priest;
	level = 15;
...
{
	name[0] = CZ_NAME_Monster_Skeleton_Ghost;
	guild = GIL_SKELETON;
	aivar[AIV_MM_REAL_ID] = ID_SKELETON;
	flags = NPC_FLAG_GHOST;
	level = 50;
...
{
	name[0] = CZ_NAME_Monster_Skeleton_WarriorGuard;
	level = 25;
...
{
	name[0] = CZ_NAME_Monster_Skeleton_JustAncientWarrior;
	level = 30;
	attribute[ATR_STRENGTH] = 250;
	attribute[ATR_DEXTERITY] = 250;
	attribute[ATR_HITPOINTS_MAX] = 1500;
...
{
	name[0] = CZ_NAME_Monster_Skeleton_JustAncientGuard;
	level = 40;
	attribute[ATR_STRENGTH] = 350;
	attribute[ATR_DEXTERITY] = 250;
...
{
	name[0] = CZ_NAME_Monster_Skeleton_Minion;
	level = 40;
...
{
	name[0] = CZ_NAME_Monster_Skeleton_AmuKhas;
	level = 100;
	aivar[90] = TRUE;
	aivar[94] = NPC_LEGEND;
...
{
	name[0] = CZ_NAME_Monster_Skeleton_CaptainDrake;
	level = 100;
	guild = GIL_SKELETON;
	aivar[AIV_MM_REAL_ID] = ID_SKELETON;
	aivar[90] = TRUE;
...
{
	name[0] = CZ_NAME_Monster_Skeleton_Captain;
	level = 20;
	guild = GIL_SKELETON;
	aivar[AIV_MM_REAL_ID] = ID_SKELETON;
	attribute[ATR_STRENGTH] = 250;
...
{
	name[0] = CZ_NAME_Monster_Skeleton_Pirate;
	level = 15;
	guild = GIL_SKELETON;
	aivar[AIV_MM_REAL_ID] = ID_SKELETON;
...
{
	name[0] = CZ_NAME_Monster_Skeleton_Test;
	guild = GIL_MEATBUG;
	level = 0;
...
{
	name[0] = CZ_NAME_Monster_Skeleton_XardasServant;
	guild = GIL_KDM;
	aivar[AIV_EnemyOverride] = TRUE;
	aivar[AIV_MM_REAL_ID] = ID_SKELETON;
	id = 716;
...
{
	name[0] = CZ_NAME_Monster_Skeleton_Orc_V2;
	level = 35;
...
{
	name[0] = CZ_NAME_Monster_Skeleton_ChaosMinion;
	level = 100;
...
{
	name[0] = CZ_NAME_Monster_Skeleton_Ksert_Title;
	level = 150;
...
{
	name[0] = CZ_NAME_Monster_Skeleton_AncientGuard;
	level = 70;
	aivar[94] = NPC_LEGEND;
	attribute[ATR_STRENGTH] = 500;
	attribute[ATR_DEXTERITY] = 250;
...
{
	name[0] = CZ_NAME_Monster_Skeleton_AncientSpear;
	level = 65;
	attribute[ATR_STRENGTH] = 500;
	attribute[ATR_DEXTERITY] = 250;
...
{
	name[0] = CZ_NAME_Monster_Skeleton_AncientWarrior;
	level = 65;
	aivar[94] = NPC_LEGEND;
...
{
	name[0] = CZ_NAME_Monster_Skeleton_AncientBerserker;
	level = 75;
	aivar[94] = NPC_LEGEND;
	attribute[ATR_STRENGTH] = 700;
	attribute[ATR_DEXTERITY] = 250;
...
{
	name[0] = CZ_NAME_Monster_Skeleton_DraKzar_Title;
	level = 150;
	flags = NPC_FLAG_IMMORTAL;
	aivar[AIV_EnemyOverride] = TRUE;
	aivar[90] = TRUE;
...
{
	name[0] = CZ_NAME_Monster_Skeleton_IlKzar_Title;
	level = 150;
	flags = NPC_FLAG_IMMORTAL;
	aivar[AIV_EnemyOverride] = TRUE;
	aivar[90] = TRUE;
...
{
	name[0] = CZ_NAME_Monster_Skeleton_ArKzar_Title;
	aivar[AIV_MM_REAL_ID] = ID_SKELETON;
	bodyStateInterruptableOverride = TRUE;
	level = 150;
	flags = NPC_FLAG_IMMORTAL;
...
{
	name[0] = CZ_NAME_Monster_Skeleton_DarkGuardian;
	level = 100;
	attribute[ATR_STRENGTH] = 600;
	attribute[ATR_DEXTERITY] = 250;
	attribute[ATR_HITPOINTS_MAX] = 20000;
