...
instance MENUITEM_AUDIO_SFXVOL(C_MENU_ITEM_DEF)
{
	backPic = MENU_ITEM_BACK_PIC;
	text[0] = "Звук";
	text[1] = "Уровень звуковых эффектов и речи в игре";
	posx = 1000;
...
instance MENUITEM_AUDIO_MUSIC(C_MENU_ITEM_DEF)
{
	backPic = MENU_ITEM_BACK_PIC;
	text[0] = "Музыка";
	text[1] = "Включение и отключение музыки в игре";
	posx = 1000;
...
instance MENUITEM_AUDIO_PROVIDER(C_MENU_ITEM_DEF)
{
	backPic = MENU_ITEM_BACK_PIC;
	text[0] = "Драйвер";
	text[1] = "Используемый драйвер для воспроизведения звука в игре";
	posx = 1000;
...
instance MENUITEM_AUDIO_SPEEKER(C_MENU_ITEM_DEF)
{
	backPic = MENU_ITEM_BACK_PIC;
	text[0] = "Динамики";
	text[1] = "Тип аудиосистемы для воспроизведения звука в игре";
	posx = 1000;
...
instance MENUITEM_AUDIO_REVERB(C_MENU_ITEM_DEF)
{
	backPic = MENU_ITEM_BACK_PIC;
	text[0] = "Окружение";
	text[1] = "Включает эффект реверберации звука с в игре";
	posx = 1000;
...
instance MENUITEM_AUDIO_REVERB_SPEECH(C_MENU_ITEM_DEF)
{
	backPic = MENU_ITEM_BACK_PIC;
	text[0] = "Голос";
	text[1] = "Качество эффекта реверберации речи в игре";
	posx = 1000;
...
instance MENUITEM_AUDIO_SAMPLERATE(C_MENU_ITEM_DEF)
{
	backPic = MENU_ITEM_BACK_PIC;
	text[0] = "Кач-во звука";
	text[1] = "Качество воспроизводимого звука в игре";
	posx = 1000;
