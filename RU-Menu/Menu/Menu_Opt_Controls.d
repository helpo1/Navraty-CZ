...
{
	text[0] = "Использовать простые стрелы/болты";
	text[1] = "";
	posx = CTRL_SP1_1;
...
{
	text[0] = "Использовать магические стрелы/болты";
	text[1] = "";
	posx = CTRL_SP1_1;
...
{
	text[0] = "Использовать освященные стрелы/болты";
	text[1] = "";
	posx = CTRL_SP1_1;
...
{
	text[0] = "Использовать огненные стрелы";
	text[1] = "";
	posx = CTRL_SP1_1;
...
{
	text[0] = "Использовать отравленные стрелы";
	text[1] = "";
	posx = CTRL_SP1_1;
...
{
	text[0] = "Использовать средство передвижения";
	text[1] = "";
	posx = CTRL_SP1_1;
...
{
	text[0] = "Использовать регенерацию суммонов";
	text[1] = "";
	posx = CTRL_SP1_1;
...
{
	text[0] = "Убрать наложение музыки";
	text[1] = "";
	posx = CTRL_SP1_1;
...
{
	text[0] = "Переключение режима бега";
	text[1] = "";
	posx = CTRL_SP1_1;
...
{
	text[0] = "Переключение режима стрейфа";
	text[1] = "";
	posx = CTRL_SP1_1;
...
{
	text[0] = "Отображение информации на экране";
	text[1] = "";
	posx = CTRL_SP1_1;
...
{
	text[0] = "Ловкостной взлом сундуков";
	text[1] = "";
	posx = CTRL_SP1_1;
